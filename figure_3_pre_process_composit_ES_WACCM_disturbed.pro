...
for iii = 0L, n_elements(dayzeros) - 1L do begin
	if dayzeros[iii] ge 60L and dayzeros[iii] then begin
...
save, filename = '../Post_process/Figure_3_pre_process_composit_ES_WACCM_disturbed.sav', t1to30,t31to60,t_1to_30, $
...
maxZ1to30,maxZ31to60,maxZ_1to_30,maxZ_31to_60,maxT1to30,maxT31to60,maxT_1to_30,maxT_31to_60
