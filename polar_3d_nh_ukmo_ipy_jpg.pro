;
; IPY version has 3 lidar sites superimposed
...
;dir='/Volumes/Data/earth/aura3/data/UKMO_data/Datfiles/ukmo_'
iyr = lstyr
idy = lstdy
imn = lstmn
...
;   xyouts,.8,.11,'Eureka (80N,86W)',charsize=1.5,/normal,color=mcolor*.3,charthick=2
    xyouts,.7,.12,'Kangerlussuaq (67!uo!nN,51!uo!nW)',charsize=1.5,/normal,color=mcolor*.1,charthick=2
    xyouts,.7,.10,'Chatanika (65!uo!nN,147!uo!nW)',charsize=1.5,/normal,color=mcolor*.95,charthick=2
    xyouts,.7,.08,'Kulungsborn (54!uo!nN,12!uo!nE)',charsize=1.5,/normal,color=mcolor*.35,charthick=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim IPY/'+sdate+'_3D.ps -rotate -90 IPY/'+sdate+'_3D.jpg'
