...
;
      z2(0:nlg/2-1,0:nlat-1)=zp(nlg/2:nlg-1,0:nlat-1,lsfc)/1000.
      z2(nlg/2:nlg-1,0:nlat-1)=zp(0:nlg/2-1,0:nlat-1,lsfc)/1000.
      z2(nlg,*)=z2(0,*)
      t2(0:nlg/2-1,0:nlat-1)=tp(nlg/2:nlg-1,0:nlat-1,lsfc)
      t2(nlg/2:nlg-1,0:nlat-1)=tp(0:nlg/2-1,0:nlat-1,lsfc)
      t2(nlg,*)=t2(0,*)
      th2=t2*(1000./rsfc)^.286
print,min(th2),max(th2)
...
; Mercator projection
      ...
      erase
      !type=2^2+2^3
      contour,th2,x,alat,levels=level,/cell_fill,/noeras,$
              title='!6'+mtitle,c_color=col1,charsize=1.5,$
              xticks=6,yticks=6,xtitle='!6Longitude',$
              ytitle='!6Latitude',xrange=[0.,360.],yrange=[-90.,90]
      contour,th2,x,alat,levels=level,/overplot,c_color=[0],$
      ...
      result=moment(th2)
      print,imn,idy,iyr,max(th2),result(0),min(th2)
