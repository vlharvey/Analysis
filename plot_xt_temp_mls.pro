;
; plot longitude-time sections of MLS Temperature
...
dtr=pi2/360.
re=6.37E3
dir='/aura2/harvey/Hovmoller/Datfiles/mls_'
...
;       for j=0,nr-1 do begin
        for j=29,29 do begin
            ...
            if setplot eq 'ps' then begin
               ...
               !p.font=0
               device,font_size=9
               device,/landscape,bits=8,filename='hov_Tmark_'+sth+'km_'+slat+'_'+sfile(0)+'_mls.ps'
               device,/color
            ...
            mtitle='MLS Temperature '+sth+' km '+slat
...
imax=max(level)
            ...
            if setplot eq 'ps' then begin
               device, /close
               spawn,'convert -trim hov_Tmark_'+sth+'km_'+slat+'_'+sfile(0)+'_mls.ps '+$
                     '-rotate -90 hov_Tmark_'+sth+'km_'+slat+'_'+sfile(0)+'_mls.jpg'
            endif
