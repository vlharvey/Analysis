...
;
      ...
      for ifile=0L,0L do begin	;n_elements(ncfiles)-1L do begin
...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='polar_lat+height_'+sdate+'_'+slev0+'_waccm_Traject_4pan_sh.ps'
       device,/color
...
;velovect,u,v,x,alat,color=0,/overplot,length=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim polar_lat+height_'+sdate+'_'+slev0+'_waccm_Traject_4pan_sh.ps -rotate -90 polar_lat+height_'+sdate+'_'+slev0+'_waccm_Traject_4pan_sh.jpg'
       spawn,'rm -f polar_lat+height_'+sdate+'_'+slev0+'_waccm_Traject_4pan_sh.ps'
    endif
jumplev:
