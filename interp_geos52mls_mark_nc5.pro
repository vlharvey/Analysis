...
sdate=result2(0)
print,sdate
dum=findfile(pthout+'mark_mls_'+sver+'.geos5.'+sdate+'_nc5.sav')
...
; save daily DMP file
;
save,file=pthout+'mark_mls_'+sver+'.geos5.'+sdate+'_nc5.sav',id,date,time,longitude,latitude,altitude,mark_prof
print,'saved mark_mls_'+sver+'.geos5.'+sdate+'_nc5.sav'
jumpday:
