...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   device,font_size=9
   device,/landscape,bits=8,filename='hirdls-ace_yz_'+adate0+'-'+adate1+'_o3update.ps'
   device,/color
   device,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize
endif

erase
hdata=HIRDLS_o3YZ*1.e6
adata=ace_o3YZ*1.e6
ddata=diff_o3YZ
...
;
    ...
    contour,hdata,latbin,altitude,xrange=[-90.,90.],yrange=[10.,60.],xticks=6,ytitle='Altitude (km)',$
            ...
            title='HIRDLS Update Ozone '+hdate0+'-'+hdate1,c_color=col1,color=0,min_value=-99999.
...
;   contour,ddata,latbin,altitude,/overplot,levels=[0],color=mcolor,/follow,min_value=-99999.,thick=3
    ...
    contour,adata,latbin,altitude,xrange=[-90.,90.],yrange=[10.,60.],xticks=6,ytitle='Altitude (km)',$
            xtickname=xlabs,charsize=2.5,levels=level,/cell_fill,$
            title='ACE Ozone '+adate0+'-'+adate1,c_color=col1,color=0,min_value=-99999.
...
if x(0) ne -1L then ddata(x)=-99999.
    ...
    contour,ddata,latbin,altitude,xrange=[-90.,90.],yrange=[10.,60.],xticks=6,$
            ...
            title='HIRDLS-ACE Ozone Difference (%)',c_color=col1,color=0,min_value=-99999.,xtitle='Latitude'
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim hirdls-ace_yz_'+adate0+'-'+adate1+'_o3update.ps -rotate -90 hirdls-ace_yz_'+adate0+'-'+adate1+'_o3update.jpg'
endif
end
