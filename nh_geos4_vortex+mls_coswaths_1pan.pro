...
;
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='nh_geos4_vortex+mls_coswaths_'+sdate+'_1pan.ps'
       device,/color
...
;
    ...
    mark(nc,*)=mark(0,*)
    map_set,90,0,-90,/stereo,/contin,/grid,color=0,/noeras,limit=[20,0,90,360],$
...
loadct,38
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim nh_geos4_vortex+mls_coswaths_'+sdate+'_1pan.ps -rotate -90 '+$
             'nh_geos4_vortex+mls_coswaths_'+sdate+'_1pan.jpg'
       spawn,'/usr/bin/rm -f nh_geos4_vortex+mls_coswaths_'+sdate+'_1pan.ps'
    endif
    icount=icount+1L
goto,jump
end
