;
; test circumpolar anticyclone algorithm
;
@stddat
@kgmt
@ckday
...
lstmn=1 & lstdy=1 & lstyr=90 & lstday=0
ledmn=1 & leddy=1 & ledyr=4 & ledday=0
;
...
;
;***Read WACCM data
      ifile=dirh+syr+smn+sdy+'.nc3'
      print,ifile
      rd_waccm3_nc3,ifile,nc,nr,nth,xlon,xlat,th,pv2,p2,$
