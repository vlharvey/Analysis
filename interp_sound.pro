pro interp_sound,ilev,llev,dummy1,dummy2,x_theta,theta_lev
scale=0.
x_theta=9999.

; if desired theta surface is above highest allowable theta or
; is below lowest allowable theta then keep x_theta=9999.
if max(dummy2) lt theta_lev or min(dummy2) gt theta_lev then return

for l=ilev,llev-1 do begin
if dummy1(l-1) ne 9999. and dummy1(l) ne 9999. and $
