...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   device,font_size=9
   device,/landscape,bits=8,filename='hirdls-ace_yz_'+adate0+'-'+adate1+'_no2.ps'
   device,/color
...
;
    ...
    contour,hdata,latbin,altitude,xrange=[-90.,90.],yrange=[15.,50.],xticks=6,ytitle='Altitude (km)',$
            ...
            title='HIRDLS NO!l2!n '+hdate0+'-'+hdate1,c_color=col1,color=0,min_value=-99999.
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim hirdls-ace_yz_'+adate0+'-'+adate1+'_no2.ps -rotate -90 hirdls-ace_yz_'+adate0+'-'+adate1+'_no2.jpg'
endif
end
