...
lstmn=2L & lstdy=12L & lstyr=2006L
...
;
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='polar_mls_co+meto_edge_nh_pv_'+sdate+'_'+slev+'_v1.5_vortex.ps'
         device,/color
...
;        plots,vavg_co+vsig_co,ymax,color=mcolor*.9,/continue,linestyle=5,thick=2
      ...
      if setplot eq 'ps' then begin
         device,/close
         spawn,'convert -trim polar_mls_co+meto_edge_nh_pv_'+sdate+'_'+slev+'_v1.5_vortex.ps -rotate -90 '+$
               'polar_mls_co+meto_edge_nh_pv_'+sdate+'_'+slev+'_v1.5_vortex.jpg'
         spawn,'/usr/bin/rm polar_mls_co+meto_edge_nh_pv_'+sdate+'_'+slev+'_v1.5_vortex.ps'
      endif
      icount=icount+1L
goto,jump
end
