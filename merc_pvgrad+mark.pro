...
pvgrad(index)=0./0.
        ...
        if setplot eq 'ps' then begin
         ...
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
                /bold,/color,bits_per_pixel=8,/helvetica,filename='merc_'+ifile+'_'+stheta+'K_pvgrad+mark.ps'
         !p.charsize=1.25
         !p.thick=2
         !p.charthick=5
         !p.charthick=5
...
; Set plot boundaries
        ...
        xyouts,.275,.95,'13 February 2002 '+stheta+' K',/normal,charsize=2,charthick=2,color=0
        MAP_SET,0,0,0,/noeras,/contin,/noborder,charsize=2.0,color=0,limit=[40.,0.,90.,360.]
...
sfmin=-0.05
        ...
        MAP_SET,0,0,0,/noeras,/contin,/grid,title='PV Gradient',charsize=1.5,$
              color=0,limit=[40.,0.,90.,360.]
xyouts,-180.,40.,'40',/data,color=0,charsize=1.5,charthick=2,alignment=1
xyouts,-180.,50.,'50',/data,color=0,charsize=1.5,charthick=2,alignment=1
xyouts,-180.,60.,'60',/data,color=0,charsize=1.5,charthick=2,alignment=1
xyouts,-180.,70.,'70',/data,color=0,charsize=1.5,charthick=2,alignment=1
xyouts,-180.,80.,'80',/data,color=0,charsize=1.5,charthick=2,alignment=1
xyouts,-180.,90.,'90',/data,color=0,charsize=1.5,charthick=2,alignment=1
xyouts,xmn-0.06,ymn+0.1,'Latitude',charsize=1.5,/normal,color=0,charthick=2,orientation=90
xyouts,0.,35.,'0',/data,color=0,charsize=1.5,charthick=2,alignment=0.5
xyouts,90.,35.,'90',/data,color=0,charsize=1.5,charthick=2,alignment=0.5
xyouts,180.,35.,'180',/data,color=0,charsize=1.5,charthick=2,alignment=0.5
xyouts,270.,35.,'270',/data,color=0,charsize=1.5,charthick=2,alignment=0.5
xyouts,xmn+0.3,ymn-0.05,'Longitude',charsize=1.5,/normal,color=0,charthick=2
...
; vertical color bar
      ...
      omin=min(sflevel)
      omax=max(sflevel)
      plot,[0,0],[omin,omax],xrange=[0,10],yrange=[omin,omax],color=0,charthick=2,charsize=1.5
      xbox=[0,10,10,0,0]
      y1=omin
      ...
      ymx=yorig(1)+ylen
      set_viewport,xmn,xmx,ymn,ymx
      MAP_SET,0,0,0,/noeras,/contin,title='Potential Vorticity',charsize=1.5,$
              color=0,limit=[40.,0.,90.,360.]
      index=where(lat gt 0.)
      sfmin=min(pv(index))
      sfmax=max(pv(index))
      ...
      contour,marksfl,x,alat,/overplot,levels=[0.1],thick=10,color=0
      contour,marksfl,x,alat,/overplot,levels=[-0.1],thick=10,color=mcolor
      MAP_SET,0,0,0,/noeras,/contin,/grid,charsize=2.0,color=0,limit=[40.,0.,90.,360.]
xyouts,-180.,40.,'40',/data,color=0,charsize=1.5,charthick=2,alignment=1
xyouts,-180.,50.,'50',/data,color=0,charsize=1.5,charthick=2,alignment=1
xyouts,-180.,60.,'60',/data,color=0,charsize=1.5,charthick=2,alignment=1
xyouts,-180.,70.,'70',/data,color=0,charsize=1.5,charthick=2,alignment=1
