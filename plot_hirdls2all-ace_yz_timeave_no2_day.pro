...
restore,file='/aura3/data/HIRDLS_data/Analysis/HIRDLS2ALL_no2_20060501-20060531_locatimes_15-17.sav'
...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   device,font_size=9
   device,/landscape,bits=8,filename='hirdls2all-ace_yz_'+adate0+'-'+adate1+'_no2_day.ps'
   device,/color
...
;
    ...
    contour,hdata,latbin,altitude,xrange=[-90.,90.],yrange=[15.,50.],xticks=6,ytitle='Altitude (km)',$
            ...
            title='HIRDLS v2.02 NO!l2!n LocTime=15-17 '+hdate0+'-'+hdate1,c_color=col1,color=0,min_value=-99999.
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim hirdls2all-ace_yz_'+adate0+'-'+adate1+'_no2_day.ps -rotate -90 hirdls2all-ace_yz_'+adate0+'-'+adate1+'_no2_day.jpg'
endif
end
