...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='figure_2.ps'
endif
erase
!type=2^2+2^3
xmn=xorig(0)
...
;
    if itime eq 0L then begin
       plot,pvfreqmean,th,xrange=[0.,100.],yrange=[300.,max(th)],color=0,/nodata,$
            xtitle='% of the time',ytitle='Theta (K)'
    endif
...
xyouts,80.,500.,'SH',color=0,/data,charsize=2
...
xyouts,80.,500.,'NH',color=0,/data,charsize=2
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim figure_2.ps -rotate -90 figure_2.jpg'
;  spawn,'/usr/bin/rm figure_2.ps'
endif
end
