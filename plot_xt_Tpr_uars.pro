...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='hov_Tprmark_'+sth+'K_'+slat+'_uars.ps'
   device,/color
...
mtitle='MetO T-Tavg '+sth+' K '+slat
plt=reform(tprxtall,nc,nfile*nyear)
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim hov_Tprmark_'+sth+'K_'+slat+'_uars.ps '+$
         '-rotate -90 hov_Tprmark_'+sth+'K_'+slat+'_uars.jpg'
endif
jump2:
end
