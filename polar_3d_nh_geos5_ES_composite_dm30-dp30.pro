;
; ES Composite Days -30 to day +30 
;
@stddat
@kgmt
@ckday
...
RADG = !PI / 180.
FAC20 = 1.0 / TAN(45.*RADG)
restore,'ES_composite_days_geos5_dm30-dp30.sav' ;,alon,alat,th,nc,nr,nth,pv2_comp,p2_comp,u2_comp,v2_comp,qdf2_comp,q2_comp,msf2_comp,vp2_comp,sf2_comp,mark2_comp

    for iday=0,59L do begin
        iday0=iday-30
...
;
        ...
        msf2=reform(msf2_comp(*,*,*,iday))
        vp2=reform(vp2_comp(*,*,*,iday))
...
;        !p.font=0
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
                /bold,/color,bits_per_pixel=8,/times,filename='../Figures/ES_Composite_Day_'+sday+'_3D_geos.ps'
         !p.charsize=1.25
         !p.thick=2
         !p.charthick=5
         !p.charthick=5
...
;
    ...
    !psym=0
    xyouts,0.2,0.9,'ES Composite Day '+sday,/normal,charsize=2,color=0,charthick=5
...
;
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim ../Figures/ES_Composite_Day_'+sday+'_3D_geos.ps -rotate -90 ../Figures/ES_Composite_Day_'+sday+'_3D_geos.png'
       spawn,'rm -f ../Figures/ES_Composite_Day_'+sday+'_3D_geos.ps'
    endif
