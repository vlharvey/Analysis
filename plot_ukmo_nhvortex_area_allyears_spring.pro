...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='ukmo_nhvortex_area_allyears_'+sth+'K_spring.ps'
   device,/color
...
amax=120.
amin=0.
plot,[1,kday0,kday0,1,1],[0.,0.,kday0,kday0,0.],min_value=0.,color=0,$
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim ukmo_nhvortex_area_allyears_'+sth+'K_spring.ps -rotate -90 ukmo_nhvortex_area_allyears_'+sth+'K_spring.jpg'
endif
end
