...
;
      ...
      if setplot eq 'ps' then begin
         ...
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='figure_1_'+sdate+'_new_msf.ps'
      endif
      thlev1=3600.
...
;     level=-1.e-5+1.e-6*findgen(21)
      ...
      contour,msf,x,alat,/overplot,levels=level,c_color=col1,/noeras,/cell_fill
      contour,msf,x,alat,/overplot,levels=level,color=0,/noeras,/follow,c_labels=0,thick=2
      ...
      plot,[0,0],[imin,imax],xrange=[0,10],yrange=[imin,imax],title='m!u2!ns!u-2!n',color=0,xticks=4
      xbox=[0,10,10,0,0]
      y1=imin
...
pvmin=0.
      ...
      if setplot eq 'ps' then begin
         device,/close
         spawn,'convert -trim figure_1_'+sdate+'_new_msf.ps -rotate -90 figure_1_'+sdate+'_new_msf.jpg'
;        spawn,'/usr/bin/rm figure_1_'+sdate+'_new_msf.ps'
      endif
