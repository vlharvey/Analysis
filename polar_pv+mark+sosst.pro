...
;         stheta=strcompress(string(fix(theta)),/remove_all)
          if setplot eq 'ps' then begin
             ...
             !p.font=0
             device,font_size=9
             device,/landscape,bits=8,filename=ifile+'_'+stheta+'K_pv+mark+sosst.ps'
             device,/color
...
;
      ...
      if setplot eq 'ps' then begin
         device, /close
          spawn,'convert -trim '+ifile+'_'+stheta+'K_pv+mark+sosst.ps '+$
          ' -rotate -90 '+ifile+'_'+stheta+'K_pv+mark+sosst.jpg'
      endif
