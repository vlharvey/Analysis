...
;
      ...
      index=where(th ge 450 and th le 4600.,nth)
...
;
      ...
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='PV_vs_SF/nogaps_sh_sf_pv_difflat_'+sdate+'.ps'
         device,/color
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim PV_vs_SF/nogaps_sh_sf_pv_difflat_'+sdate+'.ps -rotate -90 '+$
         'PV_vs_SF/nogaps_sh_sf_pv_difflat_'+sdate+'.jpg'
   spawn,'/usr/bin/rm PV_vs_SF/nogaps_sh_sf_pv_difflat_'+sdate+'.ps'
endif
...
save,file='nogaps_sh_sf_pv_difflat_save_daily.sav',sfdiff_all,pvdiff_all,sdates,th
end
