...
;
      ...
      if setplot eq 'ps' then begin
         ...
         device,/landscape,bits=8,$
                 filename='soundings+ukmo_'+stheta+'K_.ps'
         device,/color
...
; Set plot boundaries
      ...
      contour,t,x,alat,levels=tlevel,c_color=col1,/cell_fill,/noeras,$
              title='!6UKMO Temperature on '+date+' at '+stheta+' K',charsize=1.5,$
      ...
      if norbits3 gt 0 then begin
         ...
         for i=0,norbit-1 do begin
             ...
             if index(0) eq -1 then goto,skipsage3prof
      ...
      if norbits2 gt 0 then begin
         ...
         for i=0,norbit-1 do begin
             ...
             index=where(o3prof gt 0.)
             if index(0) eq -1 then goto,skipsage2prof
             o3prof=o3prof(index)*1.e6
...
;            oplot,[xx,xx],[yy,yy],psym=8,symsize=2,color=icolmax*.9
      ...
      if norbitp3 gt 0 then begin
         ...
         for i=0,norbit-1 do begin
             ...
             index=where(o3prof gt 0.)
             if index(0) eq -1 then goto,skippoam3prof
             o3prof=o3prof(index)*1.e6
...
;            oplot,[xx,xx],[yy,yy],psym=8,symsize=2,color=0
      ...
      if norbith gt 0 then begin
         ...
         for i=0,norbit-1 do begin
             ...
             index=where(o3prof gt 0.)
             if index(0) eq -1 then goto,skiphalprof
             o3prof=o3prof(index)*1.e6
...
;
; NH HALOE and SAGE III ozone soundings
;
      !type=2^2+2^3
      xmn=xorig(1)
      xmx=xorig(1)+0.3
      ...
      ymx=ymn+0.4
      set_viewport,xmn,xmx,ymn,ymx
      plot,[0,12],[400,1200],yrange=[400,1200],/nodata,$
           xrange=[0,12],charsize=1.5,ytitle='!6Theta (K)',$
           xtitle='!6Ozone (ppmv)',title='!6Northern Hem'
      if norbits3 gt 0L then begin
         for i=0,norbits3-1 do begin
             ...
             o3prof=o3prof(index)*1.e6
             thprof=reform(thsage3(i,index))
             if yy gt 0. then oplot,o3prof,thprof,color=mcolor,thick=2
         endfor
         xyouts,6,500,'!6SAGE III',color=mcolor,/data,charsize=2
      endif
      if norbith gt 0L then begin
         for i=0,norbith-1 do begin
             ...
             o3prof=o3prof(index)*1.e6
             thprof=reform(thhal(i,index))
             if yy gt 0. then oplot,o3prof,thprof,color=mcolor*.9,thick=2
         endfor
         xyouts,6,430,'!6HALOE',color=mcolor*.9,/data,charsize=2
      endif
;
; SH HALOE and SAGE III ozone soundings
;
      !type=2^2+2^3
      xmn=xorig(2)
      xmx=xorig(2)+0.3
      ...
      plot,[0,12],[400,1200],yrange=[400,1200],/nodata,$
           xrange=[0,12],charsize=1.5,ytitle='!6Theta (K)',$
           xtitle='!6Ozone (ppmv)',title='!6Southern Hem'
      if norbits3 gt 0L then begin
         for i=0,norbits3-1 do begin
             yy=ysage3(i)
             o3prof=reform(o3sage3(i,*))
             ...
             o3prof=o3prof(index)*1.e6
             thprof=reform(thsage3(i,index))
             if yy lt 0. then oplot,o3prof,thprof,color=mcolor,thick=2
         endfor
         xyouts,6,500,'!6SAGE III',color=mcolor,/data,charsize=2
      endif
      if norbith gt 0L then begin
         for i=0,norbith-1 do begin
             ...
             o3prof=o3prof(index)*1.e6
             thprof=reform(thhal(i,index))
             if yy lt 0. then oplot,o3prof,thprof,color=mcolor*.9,thick=2
         endfor
         xyouts,6,430,'!6HALOE',color=mcolor*.9,/data,charsize=2
      endif
      ...
      if setplot eq 'x' then begin
         ...
         write_gif,'haloe+sage_soundings+ukmo_'+stheta+'K.gif',img
      endif
