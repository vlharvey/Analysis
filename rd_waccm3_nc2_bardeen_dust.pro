pro rd_waccm3_nc2_bardeen_dust,file1,nlg,nlat,nth,alon,alat,thlev,$
    ipv,prs,u,v,qdf,vp,sf,q,dust_ad,dust_md,dust_mmr,dust_nd,dust_re,iflg
iflg=0
dum1=findfile(file1)
...
ncdf_varget,ncid,10,q
ncdf_varget,ncid,11,dust_ad
ncdf_varget,ncid,12,dust_md
ncdf_varget,ncid,13,dust_mmr
ncdf_varget,ncid,14,dust_nd
ncdf_varget,ncid,15,dust_re
ncdf_close,ncid
end
