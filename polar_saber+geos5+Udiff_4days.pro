...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='polar_saber+geos5+Udiff_4day_'+salt+'.ps'
   device,/color
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim polar_saber+geos5+Udiff_4day_'+salt+'.ps '+$
         ' -rotate -90 polar_saber+geos5+Udiff_4day_'+salt+'.jpg'
endif
end
