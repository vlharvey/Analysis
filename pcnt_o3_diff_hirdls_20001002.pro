...
index=where(yhal gt 10.,norbith)
thal=thal(index)
xhal=xhal(index)
yhal=yhal(index)
o3hal=o3hal(index,*)
...
;     Hfile=hdir+'HIRDLS2_'+syr+'d'+sday+'_MZ3_c1.he5'
      Hfile=hdir+'HIRDLS-Aura_L2_sMZ3-t--c2_'+syr+'d'+sday+'.he5'
;     Hfile=hdir+'HIRDLS-Aura_L2_sMZ3-fnoise--c1_'+syr+'d'+sday+'.he5'
;     Hfile=hdir+'HIRDLS-Aura_L2_sMZ3-fnonoise--c1_'+syr+'d'+sday+'.he5'
      print,hfile

;; load HIRDLS data all at once
      hirdls=LoadAuraData(Hfile, [GeoLoc, SpeciesNames])
;
; extract and hirdls variables
...
;    index=where(o3coinsage2(i,*) gt 0. and o3coinsage2(i,*) lt 1.)
;    o3prof=reform(o3coinsage2(i,index))*1.e6
;    thprof=reform(thcoinsage2(i,index))
;    oplot,o3prof,thprof,color=mcolor*.9
;endfor
;for i=0L,pcoin3-1L do begin
;    index=where(o3coinpoam3(i,*) gt 0. and o3coinpoam3(i,*) lt 1.)
;    o3prof=reform(o3coinpoam3(i,index))*1.e6
;    thprof=reform(thcoinpoam3(i,index))
;    oplot,o3prof,thprof
;endfor
;stop
;
...
erase
!type=2^2+2^3
sdate=strcompress(string(FORMAT='(I4,I2.2,I2.2)',lstyr,lstmn,lstdy))
xyouts,.2,.86,'HIRDLS "truth data" '+sdate,/normal,charsize=2
xmn=xorig(0)
xmx=xorig(0)+xlen
ymn=yorig(0)
ymx=yorig(0)+ylen
...
xyouts,25.,2000.,'HIRDLS ('+snhir+')',/data,charsize=1.2
xyouts,25.,1900.,'HALOE ('+snhal+')',/data,charsize=1.2
...
xyouts,25.,2000.,'HIRDLS ('+snhir+')',/data,charsize=1.2
xyouts,25.,1900.,'POAM III ('+snpoam3+')',/data,charsize=1.2
