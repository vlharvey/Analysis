...
if keyword_set(print) then begin
  set_plot, 'PS'
  device, file='temh4.eps', xsize=7.0, ysize=7.0, $
...
contour, vs, days, ilev, lev=vlev, c_col = ccol, /follow, /ylog, $
  yrange=[1,1e-4], ystyle=1, /cell, title = 'V* 55-70N (m/s)', $
  xticks = xticks, xtickn = xtickn, xtickv = xtickv, xran = xran

contour, vs, days, ilev, lev=[-3,-2,-1,0,1,2,3,4,5], /follow, /over, $
  color=0, c_thick = [2,2,2,3,2,2,2,2,2], c_linestyle= [1,1,1,0,0,0,0,0,0]
...
contour, 100*ws, days, ilev, lev=wlev, c_col = ccol, /follow, /ylog, $
  yrange=[1,1e-4], ystyle=1, /cell, title = 'W* 75-90N (cm/s)', $
  xticks = xticks, xtickn = xtickn, xtickv = xtickv, xran = xran

contour, 100*ws, days, ilev, lev=[-2,-1.5,-1,-0.5,0,0.5,1,1.5,2], /follow, /over, $
  color=0, c_thick = [2,2,2,2,3,2,2,2,2], c_linestyle= [1,1,1,1,0,0,0,0,0]
