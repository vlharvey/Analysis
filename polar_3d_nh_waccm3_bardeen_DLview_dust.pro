...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='Figures/'+sday+'_nh_cb+dust.ps'
       device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim Figures/'+sday+'_nh_cb+dust.ps -rotate -90 Figures/'+sday+'_nh_cb+dust.jpg'
       spawn,'/usr/bin/rm Figures/'+sday+'_nh_cb+dust.ps'
    endif
