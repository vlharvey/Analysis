...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='poam_loc.ps'
   !p.thick=2
   !p.charthick=5
   !y.thick=2
   !x.thick=2
...
;       '2004','2005']	;,'2006']
syear=['1993','1994','1995','1996','1998','1999','2000','2001','2002','2003','2004','2005']
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim poam_loc.ps -rotate -90 poam_loc.jpg'
endif
end
