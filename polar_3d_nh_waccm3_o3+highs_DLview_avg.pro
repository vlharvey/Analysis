...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='3d_nh_'+mon(imonth)+'_wa3.ps'
       device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim 3d_nh_'+mon(imonth)+'_wa3.ps -rotate -90 3d_nh_'+mon(imonth)+'_wa3.jpg'
;      spawn,'/usr/bin/rm 3d_nh_'+mon(imonth)+'_wa3.ps'
    endif
