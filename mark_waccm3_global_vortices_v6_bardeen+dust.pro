...
@ckday
@kdate
@rd_waccm3_nc2_bardeen_dust
@relvort
@marker_lows_v7
@marker_highs_v6
@write_waccm3_nc3_bardeen_dust
...
dirh='/aura3/data/WACCM_data/Datfiles/h0.lynn+dust.'
lstmn=1 & lstdy=1 & lstyr=2034 & lstday=0
ledmn=12 & leddy=31 & ledyr=2034 & ledday=0
;
...
;
;***Read WACCM data
      ifile=dirh+sday+'_00Z.nc2'
      print,'reading ',ifile
      rd_waccm3_nc2_bardeen_dust,ifile,nc,nr,nth,xlon,xlat,th,pv2,p2,u2,v2,qdf2,$
         vp2,sf2,q2,dust_ad,dust_md,dust_mmr,dust_nd,dust_re,iflg
...
; Write isentropic data in netCDF format
      ofile=dirh+sday+'_00Z.nc3'
      print,'writing ',ofile
      write_waccm3_nc3_bardeen_dust,ofile,nc,nr,nth,xlon,xlat,th,pv2,p2,u2,v2,qdf2,mark2,vp2,sf2,$
            q2,dust_ad,dust_md,dust_mmr,dust_nd,dust_re
