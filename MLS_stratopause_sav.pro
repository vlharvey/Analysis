...
;-------------------------------------------------------------------------
	...
	directory='/Volumes/MacD68-2/france/MLS_data/Datfiles/stratopause/'
    	file =  dir + 'MLS_T_grid5_v3.3_20' + ifile + '.sav'
    	spawn, 'ls ' + file, nfile
		...
		if max(MLSzstrat,/nan) gt 0. then begin
			...
			date = date[0]
   			...
   			FILENAME = '/Volumes/MacD68-2/france/data/MLS_data/MLS_stratopause_20' + ifile +'.sav'
		endif
	endif
	; ---------------------------------------------------------------------
	; ---------------------------------------------------------------------
