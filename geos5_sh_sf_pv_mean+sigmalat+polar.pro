...
;
      ...
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='PV_vs_SF/geos5_sh_sf_pv_mean+sigmalat+polar_'+sdate+'.ps'
         device,/color
...
plot,sfbin(index),meanlat_sf(index,ilev),color=0,thick=2,/noeras,xtitle='SF Bins',$
     yrange=[-30.,-90.],/nodata,ytitle='Mean Latitude',xrange=[2.e-5,-5.e-6],xticks=4
...
contour,sf,alon,alat,levels=reverse(sfbin),c_color=col1,/cell_fill,/noeras,/overplot
contour,sf,alon,alat,levels=reverse(sfbin),color=0,/follow,/noeras,/overplot
...
contour,pv,alon,alat,levels=pvbin,c_color=col1,/cell_fill,/noeras,/overplot
contour,pv,alon,alat,levels=pvbin,color=0,/follow,/noeras,/overplot
map_set,-90,0,-90,/ortho,/contin,/grid,color=0,/noeras
;
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim PV_vs_SF/geos5_sh_sf_pv_mean+sigmalat+polar_'+sdate+'.ps -rotate -90 '+$
         'PV_vs_SF/geos5_sh_sf_pv_mean+sigmalat+polar_'+sdate+'.jpg'
   spawn,'/usr/bin/rm PV_vs_SF/geos5_sh_sf_pv_mean+sigmalat+polar_'+sdate+'.ps'
endif
