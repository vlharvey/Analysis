...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='waccm_noaurfco+noaurgco_mills+meto_ssw_freq_'+sth+'hPa.ps'
   !p.charsize=1.25
   !p.thick=2
   !p.charthick=5
   !p.charthick=5
...
oplot,1.+findgen(12),gwa3_nh_minor,psym=0,color=mcolor*.3,thick=10
oplot,1.+findgen(12),gwa3_sh_minor,psym=0,color=mcolor*.3,thick=10,linestyle=2
...
xyouts,6,80.,'WACCM noaurgco '+gwmiyr0+'-'+gwmiyr1,/data,color=mcolor*.3
xyouts,6,70.,'MetO '+miyr0+'-'+miyr1,/data,color=0
...
oplot,1.+findgen(12),gwa3_nh_major,psym=0,color=mcolor*.3,thick=10
oplot,1.+findgen(12),gwa3_sh_major,psym=0,color=mcolor*.3,thick=10,linestyle=2

xyouts,6,17.5,'WACCM noaurfco '+wmiyr0+'-'+wmiyr1,/data,color=mcolor*.9
xyouts,6,15,'WACCM noaurgco '+gwmiyr0+'-'+gwmiyr1,/data,color=mcolor*.3
xyouts,6,12.5,'MetO '+miyr0+'-'+miyr1,/data,color=0

if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim waccm_noaurfco+noaurgco_mills+meto_ssw_freq_'+sth+'hPa.ps -rotate -90'+$
         ' waccm_noaurfco+noaurgco_mills+meto_ssw_freq_'+sth+'hPa.jpg'
endif
end
