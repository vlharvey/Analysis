...
plotit:
restore,'/Users/harvey/Harvey_etal_2014/Post_process/vortex_area_ES_'+esdate0+'_merra.sav'
...
;
    if setplot eq 'ps' then begin
       ...
       device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
              /bold,/color,bits_per_pixel=8,/times,filename='../Figures/profs_merra_vortex_area_ES_event_'+sevent+'.ps'
       !p.charsize=1.25
       !p.thick=2
       !p.charthick=5
       !p.charthick=5
...
for i=30,90 do begin
    if i mod 5 eq 0 then oplot,area_zt_nc4(i,*),th,color=col1(i-30),thick=10
endfor
imin=-30
imax=30
...
plot,[imin,imax],[0,0],yrange=[0,10],xrange=[imin,imax],color=0,$
      xtitle='Days since ES Onset ('+esdate0+')',charthick=2,charsize=1.5
ybox=[0,10,10,0,0]
x1=imin
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim ../Figures/profs_merra_vortex_area_ES_event_'+sevent+'.ps -rotate -90 ../Figures/profs_merra_vortex_area_ES_event_'+sevent+'.jpg'
endif
