...
oplot,findgen(nfile),smooth(ytelatedge_big,3,/edge_truncate,/Nan),color=0,psym=8
...
colevel=imin+((imax-imin)/float(nlvls-1))*findgen(nlvls)
contour,ytcograd_big,findgen(nfile),yeq,levels=colevel,xrange=[0,nfile],yrange=[20,90],/noeras,color=0,c_color=col1,title='Mean CO Gradient',ytitle='Equivalent Latitude',xticks=nxticks-1,xtickname=xlabs,xtickv=xindex,charsize=1.5,charthick=2
...
colevel=imin+((imax-imin)/float(nlvls-1))*findgen(nlvls)
contour,ytprod_big,findgen(nfile),yeq,levels=colevel,xrange=[0,nfile],yrange=[20,90],/noeras,color=0,c_color=col1,title='dCO/dElat * Mean CO Gradient',ytitle='Equivalent Latitude',xticks=nxticks-1,xtickname=xlabs,xtickv=xindex,charsize=1.5,charthick=2
;
