...
; Reads in MERRA data and plots zonal and meridional centroids of the Arctic vortex (tilt with altitude) 
...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/times,filename='../Figures/merra_vortex_centroids_ES_composite.ps'
   !p.charsize=1.25
   !p.thick=2
   !p.charthick=5
   !p.charthick=5
...
restore,'/Users/harvey/Harvey_etal_2014/Post_process/ES_composite_days_merra_dm30-dp30.sav' 
...
; save
;
save,filename='merra_composite_vmoments.sav',sdays,xphase,yphase,nvort_all,ellip_all,th,altarray
;
; longitude phase
;
...
contour,xphase,-30.+findgen(ndays),th,c_color=col1,/cell_fill,xtitle='Days From ES Onset',ytitle='Theta (K)',xrange=[-30.,30.],$
        color=0,yrange=[500.,5000.],title='MERRA Vortex Centroid Longitude',levels=level,charsize=1.5,charthick=2
...
contour,yphase,-30.+findgen(ndays),th,c_color=col1,/cell_fill,xtitle='Days From ES Onset',ytitle='Theta (K)',xrange=[-30.,30.],$
        color=0,yrange=[500.,5000.],title='MERRA Vortex Centroid Latitude',levels=level,charsize=1.5,charthick=2
...
;contour,ellip_all,-30.+findgen(ndays),th,c_color=col1,/cell_fill,xtitle='Days From ES Onset',ytitle='Theta (K)',xrange=[-30.,30.],$
;        color=0,yrange=[500.,5000.],title='MERRA Vortex Ellipticity',levels=level,charsize=1.5,charthick=2
...
;endfor
      if setplot ne 'ps' then stop
        if setplot eq 'ps' then begin
           device, /close
           spawn,'convert ../Figures/merra_vortex_centroids_ES_composite.ps -rotate -90 /Users/harvey/Harvey_etal_2014/Figures/merra_vortex_centroids_ES_composite.png'
;          spawn,'rm -f ../Figures/merra_vortex_centroids_ES_composite.ps'
        endif
end
