...
; select theta levels to plot
      zindex=where(th ge 500. and th le 8000.,nth2)
...
;        !p.font=0
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
                /bold,/color,bits_per_pixel=8,/times,filename='../Figures/ES_composite_Day_'+sday+'_3D_waccm.ps'
         !p.charsize=1.25
         !p.thick=2
         !p.charthick=5
         !p.charthick=5
...
;
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim ../Figures/ES_Composite_Day_'+sday+'_3D_waccm.ps -rotate -90 ../Figures/ES_Composite_Day_'+sday+'_3D_waccm.png'
       spawn,'rm -f ../Figures/ES_Composite_Day_'+sday+'_3D_waccm.ps'
    endif
