...
@ckday
@kdate
@rd_waccm3_nc2_bardeen
@relvort
@marker_lows_v7
@marker_highs_v6
@write_waccm3_nc3_bardeen
...
dirh='/aura3/data/WACCM_data/Datfiles/h0.lynn.'
lstmn=1 & lstdy=2 & lstyr=2034 & lstday=0
ledmn=7 & leddy=31 & ledyr=2034 & ledday=0
;
...
;
;***Read WACCM data
      ifile=dirh+syr+smn+sdy+'_00Z.nc2'
      rd_waccm3_nc2_bardeen,ifile,nc,nr,nth,xlon,xlat,th,pv2,p2,u2,v2,qdf2,vp2,sf2,iflg
...
; Write isentropic data in netCDF format
      ofile=dirh+syr+smn+sdy+'_00Z.nc3'
      write_waccm3_nc3_bardeen,ofile,nc,nr,nth,xlon,xlat,th,pv2,p2,u2,v2,qdf2,mark2,vp2,sf2
