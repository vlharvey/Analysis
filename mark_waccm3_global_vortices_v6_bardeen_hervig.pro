...
@ckday
@kdate
@rd_waccm3_nc2_bardeen_hervig
@relvort
@marker_lows_v7
@marker_highs_v6
@write_waccm3_nc3_bardeen_hervig
...
dirh='/aura3/data/WACCM_data/Datfiles/h0.hervig_2x.'
lstmn=1 & lstdy=1 & lstyr=2034 & lstday=0
ledmn=1 & leddy=1 & ledyr=2034 & ledday=0
;
...
;***Read WACCM data
      ifile=dirh+'nc2'
      print,'reading ',ifile
      rd_waccm3_nc2_bardeen_hervig,ifile,nc,nr,nth,xlon,xlat,th,pv2,p2,u2,v2,qdf2,vp2,sf2,iflg
...
; Write isentropic data in netCDF format
      ofile=dirh+'nc3'
      print,'writing ',ofile
      write_waccm3_nc3_bardeen_hervig,ofile,nc,nr,nth,xlon,xlat,th,pv2,p2,u2,v2,qdf2,mark2,vp2,sf2
