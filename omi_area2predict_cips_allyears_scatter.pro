...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='omiarea2predict_cips_onset_allyears_scatter.ps'
   !p.charsize=1.2
   !p.thick=2
   !p.charthick=5
   !y.thick=2
...
pmconset_date=fltarr(2015-2007+1)
for i=2007,2015 do begin
    isea=i-2007
...
;fdoy=omifdoy
;sdates_all=omidates
;windshift_date=fltarr(2015-2007+1)
;
;for iyear=2007,2015 do begin
...
hem='SH'
yearlab_all=strarr(2015-2007+1)
o3hole_death=fltarr(2015-2007+1)
for iyear=2007,2015 do begin
    iyr=long(strmid(sdates_all,0,4))
    index=where((iyr eq iyear and fdoy ge 182.) or (iyr eq iyear+1L and fdoy lt 182.))
    iyr0=iyr(index)
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim omiarea2predict_cips_onset_allyears_scatter.ps -rotate -90 omiarea2predict_cips_onset_allyears_scatter.png'
;  spawn,'rm -f omiarea2predict_cips_onset_allyears_scatter.ps'
endif
