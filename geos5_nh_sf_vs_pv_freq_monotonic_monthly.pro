...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          ...
          filename='geos5_nh_sf_vs_pv_freq_monotonic_monthly.ps'
endif
erase
!type=2^2+2^3
xmn=xorig(0)
...
;
    spawn,'ls geos5_pv_freq_monotonic_nh_*'+stimes(itime)+'.sav',gfiles
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim geos5_nh_sf_vs_pv_freq_monotonic_monthly.ps -rotate -90 '+$
         'geos5_nh_sf_vs_pv_freq_monotonic_monthly.jpg'
   spawn,'/usr/bin/rm geos5_nh_sf_vs_pv_freq_monotonic_monthly.ps'
endif
end
