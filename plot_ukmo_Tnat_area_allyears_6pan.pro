...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='ukmo_tnat_area_allyears_6pan.ps'
   device,/color
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim ukmo_tnat_area_allyears_6pan.ps -rotate -90 ukmo_tnat_area_allyears_6pan.jpg'
endif
