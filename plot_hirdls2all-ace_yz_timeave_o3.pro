...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   device,font_size=9
   device,/landscape,bits=8,filename='hirdls2allv2.02.06-ace_yz_'+adate0+'-'+adate1+'_o3.ps'
   device,/color
   device,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize
endif

erase
hdata=HIRDLS_h2oYZ*1.e6
adata=ace_h2oYZ*1.e6
ddata=diff_h2oYZ
...
;
    ...
    contour,hdata,latbin,altitude,xrange=[-90.,90.],yrange=[10.,70.],xticks=6,ytitle='Altitude (km)',$
            ...
            title='HIRDLS v2.02.06 Ozone '+hdate0+'-'+hdate1,c_color=col1,color=0,min_value=-99999.
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim hirdls2allv2.02.06-ace_yz_'+adate0+'-'+adate1+'_o3.ps -rotate -90 hirdls2allv2.02.06-ace_yz_'+adate0+'-'+adate1+'_o3.jpg'
endif
end
