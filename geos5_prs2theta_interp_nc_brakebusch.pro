...
; Input data:  IDL> restore,'/aura7/harvey/GEOS5_data/Datfiles_Brakebusch/GEOS5.1_2004_19x2_72lev_YYYYMMDD_HHZ.sav'
; ALAT            FLOAT     = Array[96]
...
dirw='/aura7/harvey/GEOS5_data/Datfiles_Brakebusch/'
spawn,'ls '+dirw+'GEOS5.1_*.sav',ifiles
...
FOR n=0l,nfile-1l DO BEGIN
    ...
    result3=strsplit(result2(5),'.',/extract)
    sdate=result2(4)
    stime=result3(0)
    print,sdate+stime
    dum=findfile(dirw+'GEOS5.1_2004_19x2_72lev_'+sdate+'_'+stime+'.nc')
    if dum(0) ne '' then goto,jumpfile
    restore,dirw+'GEOS5.1_2004_19x2_72lev_'+sdate+'_'+stime+'.sav'
    nc=n_elements(alon)
    nr=n_elements(alat)
    result=size(tgrd)
    nl=result(3)
...
; write theta file
;
ofile=dirw+'GEOS5.1_2004_19x2_72lev_'+sdate+'_'+stime+'.nc'
print,'writing ',ofile
