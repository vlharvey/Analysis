...
;
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='polar_mls_co+geos5_edge_nh_pv_'+sdate+'_2d_v1.5_vortex.ps'
         device,/color
...
;
      ...
      oplot,xbins,y1,color=.3*mcolor,thick=3
      y2=histogram(codata,min=-1,max=8.,binsize=.25)/float(n_elements(codata))
      oplot,xbins,y2,color=.9*mcolor,thick=3
...
;
      ...
      contour,copdf2d,xbins,th,levels=level,title='2D CO PDF',/noerase,/fill,c_color=col1,$
              ytitle='Theta (K)',xtitle='CO (ppmv)',color=0,yrange=[500.,3200.]
...
;
      ...
      contour,h2opdf2d,xbins,th,levels=level,title='2D H!l2!nO PDF',/noerase,/fill,c_color=col1,$
              ytitle='Theta (K)',xtitle='H!l2!nO (ppmv)',color=0,yrange=[500.,3200.]
...
loadct,38
      ...
      if setplot eq 'ps' then begin
         device,/close
         spawn,'convert -trim polar_mls_co+geos5_edge_nh_pv_'+sdate+'_2d_v1.5_vortex.ps -rotate -90 '+$
               'polar_mls_co+geos5_edge_nh_pv_'+sdate+'_2d_v1.5_vortex.jpg'
         spawn,'/usr/bin/rm -f polar_mls_co+geos5_edge_nh_pv_'+sdate+'_2d_v1.5_vortex.ps'
      endif
      icount=icount+1L
goto,jump
end
