...
; polar plots of NO and CO in density
;
@stddat
@kgmt
@ckday
...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='polar_nh_no+co_'+sdate+'_'+slev0+'_dens_WA3548T08CO.ps'
       device,/color
...
;   contour,z,x,alat,/overplot,levels=10+findgen(150),/follow,c_labels=0*findgen(150),/noeras,color=mcolor
    ...
    contour,speed,x,alat,/overplot,levels=50.+20.*findgen(30),/follow,c_labels=0,/noeras,color=mcolor,thick=3
...
;velovect,u,v,x,alat,color=0,/overplot,length=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim polar_nh_no+co_'+sdate+'_'+slev0+'_dens_WA3548T08CO.ps -rotate -90 polar_nh_no+co_'+sdate+'_'+slev0+'_dens_WA3548T08CO.jpg'
       spawn,'rm -f polar_nh_no+co_'+sdate+'_'+slev0+'_dens_WA3548T08CO.ps'
    endif
