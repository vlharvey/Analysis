...
;  device,/landscape,bits=8,filename='ukmo_tavg_90N_Ubar60-80N_allyears_spring_'+sth+'K.ps'
   device,/helvetica
   !p.charthick=5
   device,/portrait,/encapsulated,bits=8,filename='randall_grl2006_fig4_bw.eps'
   device,/color
...
plot,[1,kday,kday,1,1],[amin,amin,amax,amax,amin],min_value=0.,color=0,$
      ...
      ytitle='Temperature (K)',xtickname=smon,xticks=n_elements(smon)-1,xthick=5,ythick=5
...
col1=71+indgen(nlvls)*icolmax/nlvls
col1=[20.,120.,230.]
yinc=9.
restore,'c11.tbl
;tvlct,c1,c2,c3
for iyear=nyear-3L,nyear-1L do begin
    ...
    if iyear eq nyear-3L then begin
       oplot,findgen(kday),tavg_90N_ave,color=col1(0),thick=10,min_value=-9999.
       oplot,findgen(118),tavg_90N_ave(0:117),color=col1(0),thick=10,min_value=-9999.
       xyouts,kday-15.,amin+20.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=col1(0),/data
    endif
    if iyear eq nyear-2L then begin
       oplot,findgen(kday),tavg_90N_ave,color=col1(1),thick=10,min_value=-9999.
       oplot,findgen(118),tavg_90N_ave(0:117),color=col1(1),thick=10,min_value=-9999.
       xyouts,kday-15.,amin+20.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=col1(1),/data
    endif
    if iyear eq nyear-1L then begin
       oplot,findgen(kday),tavg_90N_ave,color=col1(2),thick=10,min_value=-9999.
       oplot,findgen(118),tavg_90N_ave(0:117),color=col1(2),thick=10,min_value=-9999.
       xyouts,kday-15.,amin+20.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=col1(2),/data
    endif
endfor
loadct,0
;
...
plot,[1,kday,kday,1,1],[amin,amin,amax,amax,amin],min_value=0.,color=0,$
      xrange=[1,kday],yrange=[amin,amax],/nodata,charsize=1.5,$
      ytitle='Wind Speed (ms!u-1!n)',xtickname=smon,xticks=n_elements(smon)-1L,xthick=5,ythick=5
...
for iyear=nyear-3L,nyear-1L do begin
    ...
    if iyear eq nyear-3L then begin
       oplot,findgen(kday),smax_ave,color=col1(0),thick=10,min_value=-9999.
       oplot,findgen(118),smax_ave(0:117),color=col1(0),thick=10,min_value=-9999.
       xyouts,kday-15.,amin+36.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=col1(0),/data
    endif
    if iyear eq nyear-2L then begin
       oplot,findgen(kday),smax_ave,color=col1(1),thick=10,min_value=-9999.
       oplot,findgen(118),smax_ave(0:117),color=col1(1),thick=10,min_value=-9999.
       xyouts,kday-15.,amin+36.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=col1(1),/data
    endif
    if iyear eq nyear-1L then begin
       oplot,findgen(kday),smax_ave,color=col1(2),thick=10,min_value=-9999.
       oplot,findgen(118),smax_ave(0:117),color=col1(2),thick=10,min_value=-9999.
       xyouts,kday-15.,amin+36.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=col1(2),/data
    endif
endfor
