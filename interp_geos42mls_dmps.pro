...
diru='/aura7/harvey/GEOS4_data/Datfiles/DAS.flk.asm.tavg3d_mis_e.GEOS403.MetO.'
re=40000./2./!pi
...
spawn,'ls '+pthout+'cat_mls_'+sver+'*2006*.sav',ifiles
...
sdate=result2(0)
print,sdate
dum=findfile(pthout+'dmps_mls_'+sver+'.geos4.'+sdate+'.sav')
...
;
    newday=0L
    ifile=diru+sdate0+'_1200.V01.nc3'
    dum=findfile(ifile)
...
; read data on day 1
;
    ifile=diru+sdate1+'_1200.V01.nc3'
    dum=findfile(ifile)
...
;
time=hh2
save,file=pthout+'dmps_mls_'+sver+'.geos4.'+sdate+'.sav',id,date,time,longitude,latitude,thlev,$
