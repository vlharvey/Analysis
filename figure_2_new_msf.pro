...
;
      ...
      if setplot eq 'ps' then begin
         ...
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='figure_2_'+sdate+'_new_msf.ps'
      endif
      thlev1=3600.
      thlev=1000.
...
;     xyouts,.4,.7,sdate,/normal,color=0,charsize=2
      ...
      plot,findgen(10),findgen(10),/nodata,xrange=[sfmax,sfmin],yrange=[40.,80.],$
           color=0,xtitle='!4W!1  (m!u2!ns!u-2!n)',ytitle='Mean Latitude',charsize=1,$
           xticks=2
      nbins=20L
...
;
      for ilev=nth-1L,0L,-1L do begin
          ...
          meanlat_sfsm=smooth(meanlat_sf_lev(index),3)
          if ilev mod 2 eq 0 or th(ilev) le 2000. then oplot,sfbin(index),meanlat_sfsm,color=col2(ilev),psym=0,thick=5
          if th(ilev) eq thlev or th(ilev) eq thlev1 then oplot,sfbin(index),meanlat_sfsm,color=0,psym=0,linestyle=2,thick=8
...
;
      ...
      set_viewport,xmx+0.08,xmx+0.125,ymn,ymx
      ...
      !type=2^2+2^3
      plot,sfdiff,th,color=0,thick=5,/noeras,xtitle='!4D !XLat',title='!4W!1',$
      ...
      plot,findgen(10),findgen(10),/nodata,xrange=[pvmin,pvmax],yrange=[40.,80.],$
           color=0,xtitle='PV (Km!u-2!nkg!u-1!ns!u-1!n)',ytitle='Mean Latitude',charsize=1,/xlog,$
...
;
      ...
      set_viewport,xmx+0.08,xmx+0.125,ymn,ymx
      plot,pvdiff,th,color=0,thick=5,/noeras,xtitle='!4D !XLat',title='PV',$
           ytitle='Theta (K)',xrange=[0.,40.],yrange=[500.,4600.],xticks=2,$
           yticks=nyticks-1,ytickname=spos,ytickv=ypos,charsize=0.8
...
col1=1+(indgen(nlvls)/float(nlvls))*mcolor
      ...
      if setplot eq 'ps' then begin
         device,/close
         spawn,'convert -trim figure_2_'+sdate+'_new_msf.ps -rotate -90 figure_2_'+sdate+'_new_msf.jpg'
;        spawn,'/usr/bin/rm figure_2_'+sdate+'_new_msf.ps'
      endif
