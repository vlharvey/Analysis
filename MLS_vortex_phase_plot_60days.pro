;-----------------------------------------------------------------------------------------------------------------------------
; Reads in MLS and GEOS data and plots zonal and meridional phase of the Arctic vortex (tilt with altitude) after ES events
;	 -------------------------------
;       |         Lynn Harvey           |
;       |         LASP, ATOC            |
...
;
    if setplot eq 'ps' then begin
       ...
       device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
              /bold,/color,bits_per_pixel=8,/times,filename='../Figures/mls_vortex_phase_ES_event_'+sevent+'.ps'
       !p.charsize=1.25
       !p.thick=2
       !p.charthick=5
       !p.charthick=5
...
;       endfor
        ...
        if setplot eq 'ps' then begin
           device, /close
           spawn,'convert -trim ../Figures/mls_vortex_phase_ES_event_'+sevent+'.ps -rotate -90 /Users/harvey/Harvey_etal_2014/Figures/mls_vortex_phase_ES_event_'+sevent+'.png'
           spawn,'rm -f ../Figures/mls_vortex_phase_ES_event_'+sevent+'.ps'
        endif
