;
; Antarctic vortex colored by dust mass mixing ratio
;
@stddat
@kgmt
@ckday
...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='Figures/'+sday+'_sh_cb+dust_mmr.ps'
       device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim Figures/'+sday+'_sh_cb+dust_mmr.ps -rotate -90 Figures/'+sday+'_sh_cb+dust_mmr.jpg'
;      spawn,'/usr/bin/rm Figures/'+sday+'_sh_cb+dust_mmr.ps'
    endif
