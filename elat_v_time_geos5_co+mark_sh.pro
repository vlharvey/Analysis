...
; read new vortex
;
      ncid=ncdf_open(dir+sdate+'_0000.V01.nc5')
...
ilev=index(0)
      ...
      for kk=ilev,ilev do begin
          ...
          elatco1=-1.*calcelat2d(cogrid,alongrid,alatgrid)
;
...
erase
!type=2^2+2^3
xyouts,.4,.95,sdate+'  '+strcompress(long(th(kk)),/remove_all)+' K',/normal,color=0,charsize=1.5
nlvls=nlat
...
contour,ytpv,1.+findgen(kday),elatbin,levels=level,color=0,c_color=col1,/noeras,$
        xrange=[1,kday],yrange=[-90,0],/fill,title='Mean PV',min_value=-9999.,yticks=6,$
        ytitle='PV based Elat'
contour,ytpv,1.+findgen(kday),elatbin,levels=level,color=0,/noeras,/follow,/overplot,min_value=-9999.
contour,ytmarkpv,1.+findgen(kday),elatbin,/overplot,levels=[0.1,0.5,0.9],color=0,thick=5,/noeras,/follow,min_value=-9999.
omin=min(level)
omax=max(level)
...
contour,ytco,1.+findgen(kday),elatbin,levels=level,color=0,c_color=col1,/noeras,$
        xrange=[1,kday],yrange=[-90,0],/fill,title='Mean CO',min_value=-9999.,yticks=6,$
        ytitle='CO based Elat'
contour,ytco,1.+findgen(kday),elatbin,levels=level,color=0,/noeras,/follow,/overplot,min_value=-9999.
contour,ytmarkco,1.+findgen(kday),elatbin,/overplot,levels=[0.1,0.5,0.9],color=0,thick=5,/noeras,/follow,min_value=-9999.
omin=min(level)
omax=max(level)
set_viewport,xmn,xmx,ymn-cbaryoff,ymn-cbaryoff+cbarydel
!type=2^2+2^3+2^6
...
contour,ytpvsig,1.+findgen(kday),elatbin,levels=level,color=0,c_color=col1,/noeras,$
        xrange=[1,kday],yrange=[-90,0],/fill,title='PV Sigma',min_value=-9999.,yticks=6,$
        ytitle='PV based Elat'
...
contour,ytcosig,1.+findgen(kday),elatbin,levels=level,color=0,c_color=col1,/noeras,$
        xrange=[1,kday],yrange=[-90,0],/fill,title='CO Sigma',min_value=-9999.,yticks=6,$
        ytitle='CO based Elat'
