...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='geos5_sh_sf_vs_pv_difflat_tz_annual_cycle.ps'
endif
;
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim geos5_sh_sf_vs_pv_difflat_tz_annual_cycle.ps -rotate -90 '+$
         'geos5_sh_sf_vs_pv_difflat_tz_annual_cycle.jpg'
;  spawn,'/usr/bin/rm geos5_sh_sf_vs_pv_difflat_tz_annual_cycle.ps'
endif
end
