...
; Mercator projection
      ...
      !type=2^2+2^3
      MAP_SET,90,0,0,/noeras,/stereo,title='WACCM QDF + SF '+mb+' '+date,charsize=2
...
velovect,uu,vv,alon,alat,/overplot,color=0
      MAP_SET,90,0,0,/GRID,/CONTIN,/noeras,/stereo
      imin=min(level)
      imax=max(level)
