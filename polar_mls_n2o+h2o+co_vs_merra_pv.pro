...
lstmn=3L & lstdy=1L & lstyr=2011L
ledmn=6L & leddy=30L & ledyr=2011L
lstday=0L & ledday=0L
;
; get date range
;
...
;
      ...
      contour,speed,x,alat,/overplot,levels=slevel,c_color=col1,/cell_fill,/noeras
...
;     slevel=70000.*findgen(20)/1.e6 ; 4000
      ...
      col1=1+indgen(nlvls)*mcolor/nlvls
      contour,pv,x,alat,/overplot,levels=slevel,c_color=col1,/cell_fill,/noeras
