pro rd_waccm3_nc,file1,nlg,nlat,nth,alon,alat,thlev,$
    ipv,prs,u,v,qdf,o3,ch4,no2,h2o,iflg
iflg=0
dum1=findfile(file1)
...
ncdf_varget,ncid,8,o3
ncdf_varget,ncid,9,ch4
ncdf_varget,ncid,10,no2
ncdf_varget,ncid,11,h2o
ncdf_close,ncid
end
