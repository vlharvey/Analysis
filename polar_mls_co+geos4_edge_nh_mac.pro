;
; enter altitude and plot MLS CO and GEOS-4 Arctic vortex
;
@stddat
@kgmt
@ckday
...
;
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='polar_mls_co+geos4_edge_nh_'+sdate+'_'+slev+'.ps'
         device,/color
...
;
      ...
      map_set,90,0,-90,/ortho,/contin,/grid,color=0,/noeras,charsize=1.5,$
              title='MLS CO + GEOS-4 Arctic Vortex '+sdate+' '+slev
...
loadct,38
      ...
      if setplot eq 'ps' then begin
         device,/close
         spawn,'convert -trim polar_mls_co+geos4_edge_nh_'+sdate+'_'+slev+'.ps -rotate -90 '+$
               'polar_mls_co+geos4_edge_nh_'+sdate+'_'+slev+'.jpg'
      endif
      icount=icount+1L
goto,jump
end
