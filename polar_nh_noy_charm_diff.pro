...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='Figures/polar_nh_noy_charm_'+sdate+'_'+slev+'_diff.ps'
       device,/color
...
;   drawvectors,nc+1,nr,x,alat,u,v,50,1
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim Figures/polar_nh_noy_charm_'+sdate+'_'+slev+'_diff.ps -rotate -90 Figures/polar_nh_noy_charm_'+sdate+'_'+slev+'_diff.jpg'
       spawn,'rm -f Figures/polar_nh_noy_charm_'+sdate+'_'+slev+'_diff.ps'
    endif
