...
;
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='yt_merra_co+mark_'+slev+'_composite.ps'
         device,/color
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim yt_merra_co+mark_'+slev+'_composite.ps -rotate -90 '+$
         'yt_merra_co+mark_'+slev+'_composite.jpg'
endif
