...
!noeras=1
dir='/aura7/harvey/GEOS5_data/Datfiles_Brakebusch/GEOS5.1_2004_19x2_72lev_'
...
; --- Test for end condition and close windows.
      ...
      ifile=string(FORMAT='(i4.4,i2.2,i2.2)',iyr,imn,idy)+'_'+stime(itime)+'.nc3'
...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='Figures/'+ifile+'_nh_brakebusch.ps'
       device,/color
...
jumplev:
    ...
    !psym=0
    xyouts,0.33,0.88,date+' '+stime(itime),/normal,charsize=3.0,color=0,charthick=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim Figures/'+ifile+'_nh_brakebusch.ps -rotate -90 Figures/'+ifile+'_nh_brakebusch.jpg'
       spawn,'/usr/bin/rm Figures/'+ifile+'_nh_brakebusch.ps'
    endif
