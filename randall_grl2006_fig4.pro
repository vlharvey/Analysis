...
;  device,/landscape,bits=8,filename='ukmo_tavg_90N_Ubar60-80N_allyears_spring_'+sth+'K.ps'
   device,/helvetica
   !p.charthick=5
   device,/portrait,/encapsulated,bits=8,filename='randall_grl2006_fig4.eps'
   device,/color
...
for iyear=nyear-3L,nyear-1L do begin
    ...
    if iyear eq nyear-3L then begin
       ...
       xyouts,kday-15.,amin+20.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=3,/data
    endif
    if iyear eq nyear-2L then begin
       ...
       xyouts,kday-15.,amin+20.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=6,/data
    endif
    if iyear eq nyear-1L then begin
       ...
       xyouts,kday-15.,amin+20.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=10,/data
    endif
endfor
loadct,38
;
...
for iyear=nyear-3L,nyear-1L do begin
    ...
    if iyear eq nyear-3L then begin
       ...
       xyouts,kday-15.,amin+35.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=3,/data
    endif
    if iyear eq nyear-2L then begin
       ...
       xyouts,kday-15.,amin+35.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=6,/data
    endif
    if iyear eq nyear-1L then begin
       ...
       xyouts,kday-15.,amin+35.-(iyear-(nyear-3L))*yinc,slab(iyear-(nyear-3L)),charsize=2,color=10,/data
    endif
endfor
