...
;
      if setplot eq 'ps' then begin
         ...
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='figure_4_'+sdate+'_new.ps'
      endif
;
...
;     xyouts,.41,.92,sdate,/normal,color=0,charsize=1.5
      ...
      plot,findgen(10),findgen(10),/nodata,xrange=[sfmin,sfmax],yrange=[pvmin,pvmax],$
           /ylog,color=0,xtitle='!4W!1  (s!u-1!n)',ytitle='Mean PV (Km!u2!nkg!u-1!ns!u-1!n)',xticks=4,charsize=1,$
...
col1=1+(indgen(nlvls)/float(nlvls))*mcolor
      ...
      if setplot eq 'ps' then begin
         device,/close
         spawn,'convert -trim figure_4_'+sdate+'_new.ps -rotate -90 figure_4_'+sdate+'_new.jpg'
;        spawn,'/usr/bin/rm figure_4_'+sdate+'_new.ps'
      endif
