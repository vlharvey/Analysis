...
; January monthly average solar flux vs geopotential height at the NP and 30 hPa
...
mgpavg30=-99.+0.*fltarr(nyear)                   ; monthly average GPH at the NP and 30 hPa
mtpavg30=-99.+0.*fltarr(nyear)                   ; monthly average temp at the NP and 30 hPa
muavgeq30=-99.+0.*fltarr(nyear)                  ; monthly average zonal wind at the equator
muavgeq50=-99.+0.*fltarr(nyear)                  ; monthly average zonal wind at the equator
muavgeq10=-99.+0.*fltarr(nyear)                  ; monthly average zonal wind at the equator
muavgeq20=-99.+0.*fltarr(nyear)                  ; monthly average zonal wind at the equator
musigeq50=-99.+0.*fltarr(nyear)                  ; monthly standard deviation of zonal wind at the equator
muchgeq50=-99.+0.*fltarr(nyear)                  ; monthly standard deviation of zonal wind at the equator
muchgeq30=-99.+0.*fltarr(nyear)                  ; monthly standard deviation of zonal wind at the equator
muchgeq10=-99.+0.*fltarr(nyear)                  ; monthly standard deviation of zonal wind at the equator
muavg60N10=-99.+0.*fltarr(nyear)                 ; monthly average zonal wind at 60 N
muavg60N1=-99.+0.*fltarr(nyear)                  ; monthly average zonal wind at 60 N
urad50=-99.+0.*fltarr(nyear)                  ; monthly average zonal wind at 50 hPa at radiosonde locations

for i=0,nyear-1L do begin
    index=where(syear eq strcompress(years(i),/remove_all) and smon eq '01',nn)
    index2=where(radyear eq strcompress(years(i),/remove_all) and radmon eq '01')
...
gpavg30=-99.+0.*fltarr(nyear)			; monthly average GPH at the NP and 30 hPa 
tpavg30=-99.+0.*fltarr(nyear)			; monthly average temp at the NP and 30 hPa 
uavgeq30=-99.+0.*fltarr(nyear)			; monthly average zonal wind at the equator
uavgeq50=-99.+0.*fltarr(nyear)			; monthly average zonal wind at the equator
uavgeq10=-99.+0.*fltarr(nyear)			; monthly average zonal wind at the equator
usigeq50=-99.+0.*fltarr(nyear)			; monthly standard deviation of zonal wind at the equator
uchgeq50=-99.+0.*fltarr(nyear)			; monthly standard deviation of zonal wind at the equator
uchgeq30=-99.+0.*fltarr(nyear)			; monthly standard deviation of zonal wind at the equator
uchgeq10=-99.+0.*fltarr(nyear)			; monthly standard deviation of zonal wind at the equator
uavg60N10=-99.+0.*fltarr(nyear)			; monthly average zonal wind at 60 N
uavg60N1=-99.+0.*fltarr(nyear)			; monthly average zonal wind at 60 N
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='Labitzke_and_Kunze_2009_Fig.7_singapore_'+slev+'_Jan.ps'
   !p.charsize=1.25
   !p.thick=2
   !p.charthick=5
   !y.thick=2
...
for i=0L,nn-1L do xyouts,f10_feb(index(i)),tpavg30(index(i)),strmid(strcompress(years(index(i)),/remove_all),2,2),$
    charsize=1,/data,color=0
xyouts,xmx,ymx+0.04,'Jan',/normal,color=0,charsize=2
;;
;; QBO changed sign
;;
;loadct,39
...
if setplot eq 'ps' then begin
device,/close
spawn,'convert -trim Labitzke_and_Kunze_2009_Fig.7_singapore_'+slev+'_Jan.ps -rotate -90 Labitzke_and_Kunze_2009_Fig.7_singapore_'+slev+'_Jan.jpg'
endif
