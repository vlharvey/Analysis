...
;------------RESTORE SAVE FILE WITH DAYS, LON, LAT FOR MLS AND GEOS----------

restore, '/Volumes/MacD68-1/france/WACCM_paper/Post_process/MLS_temp_height_mark.sav'
restore, '/Volumes/MacD68-1/france/WACCM_paper/Post_process/MLS_elevated_strat.sav'

y = ESindex

mlsmark = mlsmarks
mlsheight = mlsheights
...
dates1to30 = fltarr(n_elements(dayzeros)*30L,n_elements(lon),n_elements(lat)) 
dates31to60 = fltarr(n_elements(dayzeros)*30L,n_elements(lon),n_elements(lat)) 
dates_1to_30 = fltarr(n_elements(dayzeros)*30L,n_elements(lon),n_elements(lat)) 
dates_31to_60 = fltarr(n_elements(dayzeros)*30L,n_elements(lon),n_elements(lat)) 

for iii = 0L, n_elements(dayzeros) - 1L do begin
	if dayzeros[iii] ge 60L and dayzeros[iii] le n_elements(MLStemps[*,0,0]) - 59L then begin
		t1to30[iii*30L:(iii*30L) + 29L,*,*] = MLStemps[dayzeros[iii]:dayzeros[iii]+29L,*,*]
		t31to60[iii*30L:(iii*30L) + 29L,*,*] = MLStemps[dayzeros[iii]+30L:dayzeros[iii]+59L,*,*]
		t_1to_30[iii*30L:(iii*30L) + 29L,*,*] = MLStemps[dayzeros[iii]-30L:dayzeros[iii]-1L,*,*]
		t_31to_60[iii*30L:(iii*30L) + 29L,*,*] = MLStemps[dayzeros[iii]-60L:dayzeros[iii]-31L,*,*]
		z1to30[iii*30L:(iii*30L) + 29L,*,*] = MLSheight[dayzeros[iii]:dayzeros[iii]+29L,*,*]
		z31to60[iii*30L:(iii*30L) + 29L,*,*] = MLSheight[dayzeros[iii]+30L:dayzeros[iii]+59L,*,*]
		z_1to_30[iii*30L:(iii*30L) + 29L,*,*] = MLSheight[dayzeros[iii]-30L:dayzeros[iii]-1L,*,*]
		z_31to_60[iii*30L:(iii*30L) + 29L,*,*] = MLSheight[dayzeros[iii]-60L:dayzeros[iii]-31L,*,*]
		mark1to30[iii*30L:(iii*30L) + 29L,*,*] = MLSmark[dayzeros[iii]:dayzeros[iii]+29L,*,*]
		mark31to60[iii*30L:(iii*30L) + 29L,*,*] = MLSmark[dayzeros[iii]+30L:dayzeros[iii]+59L,*,*]
		mark_1to_30[iii*30L:(iii*30L) + 29L,*,*] = MLSmark[dayzeros[iii]-30L:dayzeros[iii]-1L,*,*]
		mark_31to_60[iii*30L:(iii*30L) + 29L,*,*] = MLSmark[dayzeros[iii]-60L:dayzeros[iii]-31L,*,*]
	...
	if dayzeros[iii] lt 60L and dayzeros[iii] gt 30L then begin
		...
		t31to60[iii*30L:(iii*30L) + 29L,*,*] = MLStemps[dayzeros[iii]+30L:dayzeros[iii]+59L,*,*]
		t_1to_30[iii*30L:(iii*30L) + 29L,*,*] = MLStemps[dayzeros[iii]-30L:dayzeros[iii]-1L,*,*]
		t_31to_60[0:dayzeros[iii]-31L,*,*] = MLStemps[0:dayzeros[iii]-31L,*,*]
		z1to30[iii*30L:(iii*30L) + 29L,*,*] = MLSheight[dayzeros[iii]:dayzeros[iii]+29L,*,*]
		z31to60[iii*30L:(iii*30L) + 29L,*,*] = MLSheight[dayzeros[iii]+30L:dayzeros[iii]+59L,*,*]
		z_1to_30[iii*30L:(iii*30L) + 29L,*,*] = MLSheight[dayzeros[iii]-30L:dayzeros[iii]-1L,*,*]
		z_31to_60[0:dayzeros[iii]-31L,*,*] = MLSheight[0:dayzeros[iii]-31L,*,*]
		mark1to30[iii*30L:(iii*30L) + 29L,*,*] = MLSmark[dayzeros[iii]:dayzeros[iii]+29L,*,*]
		mark31to60[iii*30L:(iii*30L) + 29L,*,*] = MLSmark[dayzeros[iii]+30L:dayzeros[iii]+59L,*,*]
		mark_1to_30[iii*30L:(iii*30L) + 29L,*,*] = MLSmark[dayzeros[iii]-30L:dayzeros[iii]-1L,*,*]
		mark_31to_60[0:dayzeros[iii]-31L,*,*] = MLSmark[0:dayzeros[iii]-31L,*,*]
		dates1to30[iii*30L:(iii*30L) + 29L] = dates[dayzeros[iii]:dayzeros[iii]+29L]
		dates31to60[iii*30L:(iii*30L) + 29L] = dates[dayzeros[iii]+30L:dayzeros[iii]+59L]
		dates_1to_30[iii*30L:(iii*30L) + 29L] = dates[dayzeros[iii]-30L:dayzeros[iii]-1L]
...
if nz gt 0L then z_31to_60[z]= !values.f_nan
	...
	for ii = 0L, n_elements(lat) - 1L do begin
	...
	tsmooth = smooth(waccmt,7,/nan,/edge_truncate)
	t = reform(tsmooth[*,index[0]:68])
	lonsReform = reform(lon2d[*,index[0]:68])
	latReform = reform(lat2d[*,index[0]:68])
	...
	if nindex gt 0L then  begin
		...
		ir = ir[0]-1L
		tsmooth = smooth(waccmt,7,/nan,/edge_truncate)
		t = reform(tsmooth[*,ir:68])
		lonsReform = reform(lon2d[*,ir:68])
		latReform = reform(lat2d[*,ir:68])
		y = where(t eq max(t,/nan),ny)
	...
	index = where(lat2d gt 20. and lat2d lt 82.)                                                                         
	maxtemp = 0.*lat                                                              
	for i = 0L, n_elements(lat) - 1L do maxtemp[i]= max(waccmt[*,i],/nan) 
	; FIND ALL LOCAL TEMPERATURE MAXIMA (2 ADJACENT POINTS ARE LESS THAN CENTER POINT)
	localtmax = 0. * lat
...
dayzerosdates = dates[dayzeros]
save, filename = '/Volumes/MacD68-1/france/ES_paper/Post_process/Figure_4_pre_process_composit_ES_MLS.sav', t1to30,t31to60,t_1to_30, $
...
maxZ1to30,maxZ31to60,maxZ_1to_30,maxZ_31to_60,maxT1to30,maxT31to60,maxT_1to_30,maxT_31to_60, dayzerosdates
