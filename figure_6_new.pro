...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,filename='figure_6_new_'+slat+'.ps'
   !p.charsize=1.25
   !p.thick=2
   !p.charthick=5
   !p.charthick=5
...
contour,dthdzlat,1.+findgen(kday),th,/noeras,xrange=[1.,kday-30],yrange=[500.,4000.],$
      charsize=1.25,color=0,ytitle='Theta (K)',xticklen=-0.05,$
      /fill,c_color=col1,levels=level,xticks=nxticks-1,xtickname=xlabs,xtickv=xindex
for i=0,3 do dthdzlat=smooth(reform(dttz(*,*,j)),7)
...
;endfor
xyouts,xmx+0.1,ymn-0.01,'Approximate Altitude (km)',color=0,/normal,orientation=90.
xyouts,kday+40L,500.-20.,'20',color=0,/data
xyouts,kday+40L,1000.-20.,'40',color=0,/data
xyouts,kday+40L,1500.-20.,'45',color=0,/data
xyouts,kday+40L,2000.-20.,'50',color=0,/data
xyouts,kday+40L,2500.-20.,'55',color=0,/data
xyouts,kday+40L,3000.-20.,'60',color=0,/data
xyouts,kday+40L,3500.-50.,'65',color=0,/data
xyouts,kday+40L,4000.-100.,'70',color=0,/data
xyouts,-350L,4000.-200.,'a)',color=0,/data,charsize=2
;
; SH
;
syear=strmid(sdates,0,4)
...
xyouts,kday+40L,3500.-50.,'65',color=0,/data
xyouts,kday+40L,4000.-100.,'70',color=0,/data
xyouts,-350L,4000.-200.,'b)',color=0,/data,charsize=2
...
!type=2^2+2^3+2^6
plot,[imin,imax],[0,0],yrange=[0,10],xrange=[imin,imax],color=0,xtitle='!9d!x!7h!x/!9d!xz (K/km)'
ybox=[0,10,10,0,0]
x1=imin
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim figure_6_new_'+slat+'.ps -rotate -90 figure_6_new_'+slat+'.jpg'
endif
