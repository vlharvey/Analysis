...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
;  device,font_size=9
   device,/landscape,bits=8,filename='zt_ace_nox_sh_spring_3pan+co.ps'
   device,/helvetica
   !p.charthick=5
   !x.ticklen=0.05
   !y.minor=2
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim zt_ace_nox_sh_spring_3pan+co.ps -rotate -90 zt_ace_nox_sh_spring_3pan+co.jpg'
endif
end
