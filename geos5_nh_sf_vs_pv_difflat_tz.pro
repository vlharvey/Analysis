...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='geos5_nh_sf_vs_pv_difflat_tz.ps'
endif
;
...
xyouts,xorig(0)-0.06,yorig(0)+ylen+0.01,'NH',/normal,color=0,charsize=2
contour,sfdiff_all,findgen(kday),th,xrange=[0.,kday],yrange=[300.,max(th)],c_color=col1,$
        title='Mean Lat in Vortex - Max Lat anywhere',ytitle='Theta (K)',/cell_fill,/noeras,$
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim geos5_nh_sf_vs_pv_difflat_tz.ps -rotate -90 '+$
         'geos5_nh_sf_vs_pv_difflat_tz.jpg'
;  spawn,'/usr/bin/rm geos5_nh_sf_vs_pv_difflat_tz.ps'
endif
end
