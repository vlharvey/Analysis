pro rd_WA3548T08CO_nc,file1,nlg,nlat,nth,alon,alat,thlev,$
    ipv,prs,msf,u,v,q,qdf,no,co,e,iflg
iflg=0
dum1=findfile(file1)
...
no=fltarr(nlat,nlg,nth)
co=fltarr(nlat,nlg,nth)
e=fltarr(nlat,nlg,nth)
...
ncdf_varget,ncid,10,no
ncdf_varget,ncid,11,co
ncdf_varget,ncid,12,e
ncdf_close,ncid
end
