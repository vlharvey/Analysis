...
dirh='/aura7/harvey/WACCM_data/Datfiles/TNV3_files/wa3_tnv3_'
dirh='/aura3/data/WACCM_data/Datfiles/wa3_tnv3_'
lstmn=7 & lstdy=25 & lstyr=93 & lstday=0
ledmn=1 & leddy=1 & ledyr=98 & ledday=0
;
...
;
;***Read WACCM data
      ifile=dirh+syr+smn+sdy+'.nc'
      rd_waccm3_nc,ifile,nc,nr,nth,xlon,xlat,th,pv2,p2,u2,v2,qdf2,o3,ch4,no2,h2o,iflg
      if iflg ne 0L then goto,jump
      ifile=dirh+syr+smn+sdy+'.dat'
      openr,10,ifile,/f77_unformatted
      inr=0L & inc=0L & inl=0L
      readu,10,inr,inc,inl
;     print,'dimensions ',inr,inc,inl
      alon=fltarr(inc)
      alat=fltarr(inr)
      thlev=fltarr(inl)
      readu,10,alon,alat,thlev
;     print,alon,alat,thlev
      sf2=fltarr(inr,inc,inl)
      readu,10,sf2
;     print,'sf ',sf2(10,10,10)
      close,10
...
; Write isentropic data in netCDF format
      ...
      write_waccm3_nc3,ofile,nc,nr,nth,xlon,xlat,th,pv2,p2,$
            u2,v2,qdf2,mark2,sf2,o3,ch4,no2,h2o
