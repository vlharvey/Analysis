...
dir='/Volumes/Data/MERRA2_data/Datfiles/MERRA2-on-WACCM_press_'
...
;
    if setplot eq 'ps' then begin
       ...
       ysize=nydim/100.
       set_plot,'ps'
       device,/color,/landscape,bits=8,filename='polar_merra2_gph_'+sdate+'_'+slev+'.ps'
...
; Close PostScript file and return control to X-windows
     ...
     if setplot eq 'ps' then begin
        device, /close
        spawn,'convert -trim polar_merra2_gph_'+sdate+'_'+slev+'.ps -rotate -90 '+$
                            'polar_merra2_gph_'+sdate+'_'+slev+'.jpg'
;       spawn,'rm -f polar_merra2_gph_'+sdate+'_'+slev+'.ps'
     endif
     jumpday:
goto,jump
end
