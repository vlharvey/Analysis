...
;
    ...
    write_ukmo_subvortex,dir+ifile+'_solve2.nc3.subvortex_v2',$
...
;
    ...
    if setplot eq 'ps' then begin
       ...
       device,/color,/landscape,bits=8,filename=$
              'Postscript/ukmo_'+ifile+'_'+sth+'_'+slon1+'_v2.ps'
...
; Close PostScript file and return control to X-windows
    ...
    if setplot eq 'x' then begin
       ...
       write_gif,'Gif_images/ukmo_subvortex_'+ifile+'_'+sth+'_v2.gif',img
    endif
;   stop
    jump:
