...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='merc_no+e_'+sdate+'_'+slev0+'_dens_waccm_Traject_4pan.ps'
       device,/color
    ...
    no(nc,*)=no(0,*)
    no1d=reform(co_conc(*,*,ilev,itime))
    ...
    v(nc,*)=v(0,*)
    dthdt1=reform(dthdtgrd(*,*,ilev,itime))
...
;velovect,u,v,x,alat,color=0,/overplot,length=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim merc_no+e_'+sdate+'_'+slev0+'_dens_waccm_Traject_4pan.ps -rotate -90 merc_no+e_'+sdate+'_'+slev0+'_dens_waccm_Traject_4pan.jpg'
       spawn,'rm -f merc_no+e_'+sdate+'_'+slev0+'_dens_waccm_Traject_4pan.ps'
    endif
