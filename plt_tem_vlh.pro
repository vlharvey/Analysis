...
spawn,'ls '+dir+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h4.*-00000.nc',ifiles
...
savfile = result(0)+'.'+result(1)+'.'+result(2)+'.'+result(3)+'tem.'+result(4)+'.sav'


;if keyword_set(print) then begin
  set_plot, 'PS'
  device, file='temh4_'+result(4)+'.eps', xsize=7.0, ysize=7.0, $
