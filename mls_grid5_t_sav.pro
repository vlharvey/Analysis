...
MLS_path='/Volumes/MacD68-2/france/data/MLS_data/'
...
+strcompress(string(day,format='(I02)')) + '.sav', lon, lat,  t_grid, temperature,P_grid, pressure, altitude, date, zenith_grid
