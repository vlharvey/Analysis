...
!noeras=1
dir='/aura3/data/WACCM_data/Datfiles/h0.lynn.'
...
; --- Test for end condition and close windows.
      ...
      date=strcompress(string(FORMAT='(A3,A1,I2,A2,I4)',$
                              month(imn-1),' ',idy,', ',iyr))
      ifile=string(FORMAT='(i4.4,i2.2,i2.2,a8)',iyr,imn,idy,'_00Z.nc3')
      rd_waccm3_nc3_bardeen,dir+ifile,nc,nr,nth,alon,alat,th,pv2,p2,$
         u2,v2,qdf2,mark2,vp,sf2,iflag
...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='Figures/'+ifile+'_sh_cb.ps'
       device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim Figures/'+ifile+'_sh_cb.ps -rotate -90 Figures/'+ifile+'_sh_cb.jpg'
;      spawn,'/usr/bin/rm Figures/'+ifile+'_sh_cb.ps'
    endif
