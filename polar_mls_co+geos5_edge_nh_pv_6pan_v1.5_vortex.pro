...
lstmn=10L & lstdy=1L & lstyr=2007L
...
;
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='polar_mls_co+geos5_edge_nh_pv_'+sdate+'_'+slabs(0)+'_'+slev+'_v1.5.ps'
         device,/color
...
;
      ...
      if aavg_co ne -99. then begin
         plots,aavg_co,0.
         plots,aavg_co,ymax,color=mcolor*.9,/continue,thick=3,linestyle=2
         plots,aavg_h2o,0.
         plots,aavg_h2o,ymax,color=mcolor*.3,/continue,thick=3,linestyle=2
...
;        plots,vavg_co+vsig_co,ymax,color=mcolor*.9,/continue,linestyle=5,thick=2
      ...
      if setplot eq 'ps' then begin
         device,/close
         spawn,'convert -trim polar_mls_co+geos5_edge_nh_pv_'+sdate+'_'+slabs(0)+'_'+slev+'_v1.5.ps -rotate -90 '+$
               'polar_mls_co+geos5_edge_nh_pv_'+sdate+'_'+slabs(0)+'_'+slev+'_v1.5.jpg'
         spawn,'/usr/bin/rm polar_mls_co+geos5_edge_nh_pv_'+sdate+'_'+slabs(0)+'_'+slev+'_v1.5.ps'
      endif
      jumplev:
      endfor
goto,jump
