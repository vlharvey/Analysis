...
ledmn=7L & leddy=31L & ledyr=2006L
lstday=0L & ledday=0L
;
; get date range
;
...
;  print,'# SF bins where PV increases ',th(ilev),npts
;  stop
endif
...
save,file='geos5_pv_freq_monotonic_sh_'+syr+smn+'.sav',pvfreq,pvsigma,pvlat,pvlatsigma,th,sdates,sdate0,sdate1
;
