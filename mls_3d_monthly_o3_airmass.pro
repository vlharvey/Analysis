...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/portrait,bits=8,filename='mls_3d_o3_airmass_'+mon(imonth)+'.ps'
   device,/color
...
contour,high_o3_num_all,ybin,th,/overplot,levels=[10.,100.,250.,500.,1000.,1500.,2000.,3000.,4000.],$
...
contour,vortex_o3_num_all,ybin,th,/overplot,levels=[100.,500.,1000.,2000.,3000.,4000.,5000.,7500.,10000,15000.],$
        /follow,color=mcolor,min_value=-9999.
