...
; Anticyclones in black poleward of 2.5N
...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='1989-1990/'+ifile+'_tp.ps'
       device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim 1989-1990/'+ifile+'_tp.ps -rotate -90 1989-1990/'+ifile+'_tp.jpg'
    endif
