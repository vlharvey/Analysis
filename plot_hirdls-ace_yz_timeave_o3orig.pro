...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   device,font_size=9
   device,/landscape,bits=8,filename='hirdls-ace_yz_'+adate0+'-'+adate1+'_o3orig.ps'
   device,/color
...
;
    ...
    contour,hdata,latbin,altitude,xrange=[-90.,90.],yrange=[10.,60.],xticks=6,ytitle='Altitude (km)',$
            ...
            title='HIRDLS Orig Ozone '+hdate0+'-'+hdate1,c_color=col1,color=0,min_value=-99999.
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim hirdls-ace_yz_'+adate0+'-'+adate1+'_o3orig.ps -rotate -90 hirdls-ace_yz_'+adate0+'-'+adate1+'_o3orig.jpg'
endif
end
