...
;
; exclude non SSW days
;
      if ldate lt 20031219 or $					; 20031219-20031229
        (ldate gt 20031229 and ldate lt 20040102) or $		; 20040102-20040110
        (ldate gt 20040110 and ldate lt 20050222) or $
        (ldate gt 20050301 and ldate lt 20050311) or $
        (ldate gt 20050317 and ldate lt 20060101) or $
        (ldate gt 20060103 and ldate lt 20060108) or $
        (ldate gt 20060114 and ldate lt 20060116) or $
        (ldate gt 20060124 and ldate lt 20061214) or $
        (ldate gt 20061219 and ldate lt 20061224) or $
        (ldate gt 20061226 and ldate lt 20061230) or $
        (ldate gt 20070108 and ldate lt 20070209) or $
        (ldate gt 20070211 and ldate lt 20070221) or $
        (ldate gt 20070227 and ldate lt 20070311) or $
        (ldate gt 20070315 and ldate lt 20080121) or $
        (ldate gt 20080126 and ldate lt 20080203) or $
        (ldate gt 20080207 and ldate lt 20080215) or $
        (ldate gt 20080216 and ldate lt 20080219) or $
         ldate gt 20080224 then goto,jump
;
; read GEOS-5 data
;
...
;
      ...
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='PV_vs_SF/geos5_nh_sf_pv_difflat_'+sdate+'_ssw.ps'
         device,/color
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim PV_vs_SF/geos5_nh_sf_pv_difflat_'+sdate+'_ssw.ps -rotate -90 '+$
         'PV_vs_SF/geos5_nh_sf_pv_difflat_'+sdate+'_ssw.jpg'
   spawn,'/usr/bin/rm PV_vs_SF/geos5_nh_sf_pv_difflat_'+sdate+'_ssw.ps'
endif
...
save,file='geos5_nh_sf_pv_difflat_save_daily_ssw.sav',sfdiff_all,pvdiff_all,sdates,th
end
