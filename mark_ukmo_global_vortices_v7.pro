...
ledmn=10 & leddy=27 & ledyr=3 & ledday=0
;
...
;        title=mon(imn-1)+sdy+'_'+uyr+'  '+string(theta)+' K',charsize=2
...
;if theta eq 500. then msave=markl
;contour,msave,x,xlat,/overplot,levels=[0.5],thick=3
;wait,1
;endif
          markl1=0.*qdf1
...
; Write UKMO isentropic data in netCDF format
      print,dir+ifile+'.nc3'
      write_ukmo_nc3,dir+ifile+'.nc3',nc,nr,nth,xlon,xlat,th,$
