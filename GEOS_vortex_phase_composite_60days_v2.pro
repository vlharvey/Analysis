...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/times,filename='../Figures/geos5_vortex_phase_ES_composite.ps'
   !p.charsize=1.25
   !p.thick=2
   !p.charthick=5
   !p.charthick=5
...
restore,'/Users/harvey/Harvey_etal_2014/Post_process/ES_composite_days_geos5_dm30-dp30.sav' ;,alon,alat,th,nc,nr,nth,pv2_comp,p2_comp,u2_comp,v2_comp,qdf2_comp,q2_comp,gph2_comp,ttgw2_comp,sf2_comp,mark2_comp
;
; wrap around point
;
        lons = fltarr(nc+1L)
...
contour,xphase,-30.+findgen(ndays),th,c_color=col1,/cell_fill,xtitle='Days From ES Onset',ytitle='Theta (K)',xrange=[-30.,30.],$
        color=0,yrange=[0.,6000.],title='GEOS-5 Vortex Longitude Phase',levels=level,charsize=1.5,charthick=2
...
contour,yphase,-30.+findgen(ndays),th,c_color=col1,/cell_fill,xtitle='Days From ES Onset',ytitle='Theta (K)',xrange=[-30.,30.],$
        color=0,yrange=[0.,6000.],title='GEOS-5 Vortex Latitude Phase',levels=level,charsize=1.5,charthick=2
...
x1=x1+dx
        ...
        if setplot eq 'ps' then begin
           device, /close
           spawn,'convert ../Figures/geos5_vortex_phase_ES_composite.ps -rotate -90 /Users/harvey/Harvey_etal_2014/Figures/geos5_vortex_phase_ES_composite.png'
;          spawn,'rm -f ../Figures/geos5_vortex_phase_ES_composite.ps'
        endif
end
