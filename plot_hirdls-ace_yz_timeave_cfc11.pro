...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   device,font_size=9
   device,/landscape,bits=8,filename='hirdls-ace_yz_'+adate0+'-'+adate1+'_cfc11.ps'
   device,/color
   device,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize
endif

erase
hdata=HIRDLS_cfc11YZ*1.e9
adata=ace_cfc11YZ*1.e9
ddata=diff_cfc11YZ
...
;
    ...
    contour,hdata,latbin,altitude,xrange=[-90.,90.],yrange=[0.,40.],xticks=6,ytitle='Altitude (km)',$
            ...
            title='HIRDLS CFC-11 '+hdate0+'-'+hdate1,c_color=col1,color=0,min_value=-99999.
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim hirdls-ace_yz_'+adate0+'-'+adate1+'_cfc11.ps -rotate -90 hirdls-ace_yz_'+adate0+'-'+adate1+'_cfc11.jpg'
endif
end
