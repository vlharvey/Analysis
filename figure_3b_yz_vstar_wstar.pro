...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='figure_3b_yz_vstar_wstar.ps'
   !p.charsize=1
   !p.thick=2
   !p.charthick=2
   !y.thick=2
...
;
    ...
    if setplot eq 'ps' then begin
       device, /close
       spawn,'convert -trim figure_3b_yz_vstar_wstar.ps -rotate -90 figure_3b_yz_vstar_wstar.jpg'
;      spawn,'rm -f figure_3b_yz_vstar_wstar.ps'
    endif
