...
; select theta levels to plot
    if icount eq 0L then begin
       zindex=where(th ge 300. and th le 1800.,nth2)
...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='1989-1990/'+ifile+'_o3.ps'
       device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim 1989-1990/'+ifile+'_o3.ps -rotate -90 1989-1990/'+ifile+'_o3.jpg'
    endif
