...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   device,font_size=9
   device,/landscape,bits=8,filename='hirdls2allv2.02.06-ace_yz_'+adate0+'-'+adate1+'_ch4.ps'
   device,/color
...
;
    ...
    contour,hdata,latbin,altitude,xrange=[-90.,90.],yrange=[10.,50.],xticks=6,ytitle='Altitude (km)',$
            ...
            title='HIRDLS v2.02.06 Methane '+hdate0+'-'+hdate1,c_color=col1,color=0,min_value=-99999.
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim hirdls2allv2.02.06-ace_yz_'+adate0+'-'+adate1+'_ch4.ps -rotate -90 hirdls2allv2.02.06-ace_yz_'+adate0+'-'+adate1+'_ch4.jpg'
endif
end
