...
dirm2='/atmos/harvey/MERRA2_data/Datfiles/MERRA2-on-WACCM_theta_'
...
; MERRA2
;
      dum=findfile(dirm2+sdate+'00.nc3')
      if dum ne '' then ncfile0=dirm2+sdate+'00.nc3'
...
;
; strip out MERRA2 near stratopause
;
           theta=3000.
;          print,th
...
;
; strip out MLS temperature at ialt
;
...
;
       ...
       contour,smooth(mark,3,/Nan,/edge_truncate),x,alat,levels=[0.1],/overplot,/noeras,c_color=0,/follow,thick=10
       contour,smooth(mark,3,/Nan,/edge_truncate),x,alat,levels=[-0.1],/overplot,/noeras,c_color=mcolor,/follow,thick=10
