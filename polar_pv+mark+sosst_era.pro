...
lstmn=12 & lstdy=1 & lstyr=99 & lstday=0
ledmn=12 & leddy=15 & ledyr=99 & ledday=0
...
;         stheta=strcompress(string(fix(theta)),/remove_all)
          if setplot eq 'ps' then begin
             ...
             !p.font=0
             device,font_size=9
             device,/landscape,bits=8,filename=ifile+'_'+stheta+'K_pv+mark+sosst_era.ps'
             device,/color
...
;
      ...
      if setplot eq 'ps' then begin
         device, /close
          spawn,'convert -trim '+ifile+'_'+stheta+'K_pv+mark+sosst_era.ps '+$
          ' -rotate -90 '+ifile+'_'+stheta+'K_pv+mark+sosst_era.jpg'
      endif
