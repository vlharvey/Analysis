...
dirh='/aura7/harvey/GEOS5_data/Datfiles_Brakebusch/GEOS5.1_2004_19x2_72lev_'
stime=['00Z','06Z','12Z','18Z']
ntime=n_elements(stime)
lstmn=1 & lstdy=1 & lstyr=2004 & lstday=0
ledmn=12 & leddy=31 & ledyr=2004 & ledday=0
;
...
;
      ...
      ifile=dirh+sdate+'_'+stime(itime)+'.nc2'
      print,'reading ',ifile
...
; Write isentropic data in netCDF format
      ofile=dirh+sdate+'_'+stime(itime)+'.nc3'
      print,'writing ',ofile
