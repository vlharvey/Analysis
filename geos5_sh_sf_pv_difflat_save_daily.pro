...
; SH version
; compute the mean and standard deviation of latitude within SF and PV bins
...
;        !p.font=0
;        device,font_size=9
;        device,/landscape,bits=8,filename='PV_vs_SF/geos5_sh_sf_pv_difflat_'+sdate+'.ps'
;        device,/color
...
;plot,sfdiff,th,color=0,thick=7,/noeras,xtitle='Mean Lat at Max SF - Min Lat',$
...
;if setplot eq 'ps' then begin
;   device,/close
;   spawn,'convert -trim PV_vs_SF/geos5_sh_sf_pv_difflat_'+sdate+'.ps -rotate -90 '+$
;         'PV_vs_SF/geos5_sh_sf_pv_difflat_'+sdate+'.jpg'
;   spawn,'/usr/bin/rm PV_vs_SF/geos5_sh_sf_pv_difflat_'+sdate+'.ps'
;endif
...
save,file='geos5_sh_sf_pv_diffwlat_save_daily.sav',sfdiff_all,pvdiff_all,sdates,th
end
