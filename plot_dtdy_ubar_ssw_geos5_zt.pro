...
; restore save file
;
restore,file='GEOS5_dTdy_Ubar_SSW_Climo.sav'	;,yyyymmdd,th,nh_dtdy,sh_dtdy,nh_ubar60,sh_ubar60,comment
NH_UBAR60=NH_UBAR
SH_UBAR60=SH_UBAR
nlv=n_elements(th)
;
...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='plot_dtdy_ubar_ssw_geos5_zt_'+daterange+'.ps'
   !p.charsize=1.25
   !p.thick=2
   !p.charthick=5
   !p.charthick=5
...
; Close PostScript file and return control to X-windows
     ...
     if setplot eq 'ps' then begin
        device, /close
        spawn,'convert -trim plot_dtdy_ubar_ssw_geos5_zt_'+daterange+'.ps -rotate -90 '+$
                            'plot_dtdy_ubar_ssw_geos5_zt_'+daterange+'.jpg'
;       spawn,'/usr/bin/rm plot_dtdy_ubar_ssw_geos5_zt_'+daterange+'.ps'
     endif
end
