...
spawn,'ls '+dir+'sdwaccm2012-2014_1_2_2.cam.h4tem.????.sav',ifiles
nfile=n_elements(ifiles)
for ifile=0L,nfile-1L do begin

savfile = ifiles(ifile)
result=strsplit(savfile,'.',/extract)

;if keyword_set(print) then begin
  set_plot, 'PS'
  device, file='temh4vlh_'+result(-2)+'.eps', xsize=7.0, ysize=7.0, $
