...
restore,file='/aura3/data/HIRDLS_data/Analysis/HIRDLS2ALL_h2o_v2.02.06.20060507-20060531.sav'
hdate0='20060501'
hdate1='20060531'
...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   device,font_size=9
   device,/landscape,bits=8,filename='hirdls2allv2.02.06-ace_yz_'+adate0+'-'+adate1+'_h2o.ps'
   device,/color
...
;
    ...
    contour,hdata,latbin,altitude,xrange=[-90.,90.],yrange=[10.,50.],xticks=6,ytitle='Altitude (km)',$
            ...
            title='HIRDLS v2.02.06 H!l2!nO '+hdate0+'-'+hdate1,c_color=col1,color=0,min_value=-99999.
...
;   contour,ddata,latbin,altitude,/overplot,levels=[0],color=mcolor,/follow,min_value=-99999.,thick=3
    ...
    contour,adata,latbin,altitude,xrange=[-90.,90.],yrange=[10.,50.],xticks=6,ytitle='Altitude (km)',$
            xtickname=xlabs,charsize=2.5,levels=level,/cell_fill,$
            title='ACE H!l2!nO '+adate0+'-'+adate1,c_color=col1,color=0,min_value=-99999.
...
if x(0) ne -1L then ddata(x)=-99999.
    ...
    contour,ddata,latbin,altitude,xrange=[-90.,90.],yrange=[10.,50.],xticks=6,$
            ...
            title='HIRDLS-ACE H!l2!nO Difference (%)',c_color=col1,color=0,min_value=-99999.,xtitle='Latitude'
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim hirdls2allv2.02.06-ace_yz_'+adate0+'-'+adate1+'_h2o.ps -rotate -90 hirdls2allv2.02.06-ace_yz_'+adate0+'-'+adate1+'_h2o.jpg'
endif
end
