...
; /aura7/harvey/WACCM_data/Datfiles/Datfiles_Mills/noaurfco and save in IDL save format
;
; dimensions:
...
;                Z3:units = "m" ;
;
dir='/aura7/harvey/WACCM_data/Datfiles/Datfiles_Mills/noaurfco/'
spawn,'ls '+dir+'noaurfco.vars.h3.20*.nc',ncfiles
...
for ifile=0L,nfile-1L do begin
    ...
    for ivar=0,result0.nvars-1 do begin
        ...
        if result.name ne 'PS' and result.name ne 'PSL' and $
           result.name ne 'NOX' and result.name ne 'O3' and result.name ne 'QSUM' $
...
;
    ...
    for n=0L,ntime-1L do begin
        ...
        print,ofile
        save,file=ofile,time,date,longitude,latitude,pressure,temp,ghgt,comment
