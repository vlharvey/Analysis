;
; look at SH GEOS-5 SF and PV at 1600 K and 2200 K
; why is PV delta latitude larger at 1600 K in June and July than at 2200 K?
;
@stddat
@kgmt
@ckday
...
;
      ...
      if setplot eq 'ps' then begin
         ...
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='figure_1_'+sdate+'_new_sh.ps'
      endif
      thlev1=2200.
...
;     level=-1.e-5+1.e-6*findgen(21)
      ...
      contour,speed,x,alat,/overplot,levels=[50,75,100],color=mcolor,thick=2,/noeras,/follow,c_charsize=1,c_charthick=3
...
;     contour,speed,x,alat,/overplot,levels=[75.],color=mcolor,thick=5,/noeras,/follow,c_charsize=1,c_charthick=3
      ...
      if setplot eq 'ps' then begin
         device,/close
         spawn,'convert -trim figure_1_'+sdate+'_new_sh.ps -rotate -90 figure_1_'+sdate+'_new_sh.jpg'
;        spawn,'/usr/bin/rm figure_1_'+sdate+'_new_sh.ps'
      endif
