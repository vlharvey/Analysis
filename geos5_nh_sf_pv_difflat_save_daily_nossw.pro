...
; exclude SSW days
;
      if (ldate ge 20031219 and ldate le 20031229) or $
         (ldate ge 20040102 and ldate le 20040110) or $
         (ldate ge 20050222 and ldate le 20050301) or $
         (ldate ge 20050311 and ldate le 20050317) or $
         (ldate ge 20060101 and ldate le 20060103) or $
         (ldate ge 20060108 and ldate le 20060114) or $
         (ldate ge 20060116 and ldate le 20060124) or $
         (ldate ge 20061214 and ldate le 20061219) or $
         (ldate ge 20061224 and ldate le 20061226) or $
         (ldate ge 20061230 and ldate le 20070108) or $
         (ldate ge 20070209 and ldate le 20070211) or $
         (ldate ge 20070221 and ldate le 20070227) or $
         (ldate ge 20070311 and ldate le 20070315) or $
         (ldate ge 20080121 and ldate le 20080126) or $
         (ldate ge 20080203 and ldate le 20080207) or $
         (ldate ge 20080215 and ldate le 20080216) or $
         (ldate ge 20080219 and ldate le 20080224) then goto,jump
;
; read GEOS-5 data
;
...
;
      ...
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='PV_vs_SF/geos5_nh_sf_pv_difflat_'+sdate+'_nossw.ps'
         device,/color
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim PV_vs_SF/geos5_nh_sf_pv_difflat_'+sdate+'_nossw.ps -rotate -90 '+$
         'PV_vs_SF/geos5_nh_sf_pv_difflat_'+sdate+'_nossw.jpg'
   spawn,'/usr/bin/rm PV_vs_SF/geos5_nh_sf_pv_difflat_'+sdate+'_nossw.ps'
endif
...
save,file='geos5_nh_sf_pv_difflat_save_daily_nossw.sav',sfdiff_all,pvdiff_all,sdates,th
end
