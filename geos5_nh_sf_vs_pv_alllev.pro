...
ledmn=4L & leddy=10L & ledyr=2008L
lstday=0L & ledday=0L
;
; get date range
;
...
;
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='geos5_nh_sf_vs_pv_'+sdate+'_'+slabs(0)+'_alllev.ps'
         device,/color
...
;stop
      ...
      if setplot eq 'ps' then begin
         device,/close
         spawn,'convert -trim geos5_nh_sf_vs_pv_'+sdate+'_'+slabs(0)+'_alllev.ps -rotate -90 '+$
               'geos5_nh_sf_vs_pv_'+sdate+'_'+slabs(0)+'_alllev.jpg'
         spawn,'/usr/bin/rm geos5_nh_sf_vs_pv_'+sdate+'_'+slabs(0)+'_alllev.ps'
      endif
