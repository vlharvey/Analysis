...
;        !p.font=0
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
                /bold,/color,bits_per_pixel=8,/times,filename='Collins/'+sdate+'_3D.ps'
         !p.charsize=1.25
         !p.thick=2
         !p.charthick=5
         !p.charthick=5
...
loadct,39
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim Collins/'+sdate+'_3D.ps -rotate -90 Collins/'+sdate+'_3D.png'
       spawn,'/usr/bin/rm -f Collins/'+sdate+'_3D.ps'
    endif
goto, jump
end
