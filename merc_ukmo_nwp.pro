...
;
lstmn=1 & lstdy=1 & lstyr=2007
ledmn=1 & leddy=1 & ledyr=2007
lstday=0 & ledday=0
...
if lstyr lt 1991 or lstyr gt 2006 then stop,'Year out of range '
if ledyr lt 1991 or ledyr gt 2006 then stop,'Year out of range '
...
;
      file='/aura3/data/UKMO_data/ftp/ukmo-nwp-strat_gbl-std_'+$
            string(FORMAT='(i4,i2.2,i2.2,a17)',iyr,imn,idy,'12_u-v-w-t-gph.nc')
