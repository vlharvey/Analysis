...
restore, '/Volumes/MacD68-1/france/ES_paper/Post_process/Figure_3_pre_process_composit_ES_WACCM_disturbed.sav'
...
if setplot eq 'ps' then begin
	device, /close
	spawn,'pstopnm -dpi=300 -landscape idl.ps'	spawn,'pnmtopng idl001.ppm > /Volumes/MacD68-1/france/ES_paper/Figures/WACCM_composite.png'
