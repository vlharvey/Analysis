...
lstmn=2L & lstdy=14L & lstyr=2006L
ledmn=2L & leddy=14L & ledyr=2006L
lstday=0L & ledday=0L
;
; get date range
;
...
;
      ...
      map_set,90,0,0,/ortho,/contin,/grid,color=0,/noeras,title='!4W!1'
;     level=-1.e-5+1.e-6*findgen(21)
      ...
      contour,speed,x,alat,/overplot,levels=[50.],color=mcolor,thick=5,/noeras,/follow,c_charsize=1,c_charthick=3
      map_set,90,0,0,/ortho,/contin,/grid,color=0,/noeras
...
;
      ...
      ymx=yorig(1)+ylen
      set_viewport,xmn,xmx,ymn,ymx
      map_set,90,0,0,/ortho,/contin,/grid,color=0,/noeras,title='PV'
      index=where(y2d gt 0.)
