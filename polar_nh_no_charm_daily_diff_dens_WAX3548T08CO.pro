...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='polar_nh_no_charm_'+sdate+'_'+slev0+'_diff_dens_WAX3548T08CO.ps'
       device,/color
...
;   if setplot ne 'ps' then stop
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim polar_nh_no_charm_'+sdate+'_'+slev0+'_diff_dens_WAX3548T08CO.ps -rotate -90 polar_nh_no_charm_'+sdate+'_'+slev0+'_diff_dens_WAX3548T08CO.jpg'
       spawn,'rm -f polar_nh_no_charm_'+sdate+'_'+slev0+'_diff_dens_WAX3548T08CO.ps'
    endif
