...
;
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='PV_vs_SF/geos5_sh_sf_vs_pv_'+sdate+'_'+slabs(0)+'_alllev_nash+meanlat.ps'
         device,/color
...
;     xindex=where(th eq 600. or th eq 1000. or th eq 2000. or th eq 3000. or th eq 4000. or th eq 4600.,nxticks)
      ...
      if setplot eq 'ps' then begin
         device,/close
         spawn,'convert -trim PV_vs_SF/geos5_sh_sf_vs_pv_'+sdate+'_'+slabs(0)+'_alllev_nash+meanlat.ps -rotate -90 '+$
               'PV_vs_SF/geos5_sh_sf_vs_pv_'+sdate+'_'+slabs(0)+'_alllev_nash+meanlat.jpg'
         spawn,'/usr/bin/rm PV_vs_SF/geos5_sh_sf_vs_pv_'+sdate+'_'+slabs(0)+'_alllev_nash+meanlat.ps'
      endif
