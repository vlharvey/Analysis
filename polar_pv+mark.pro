...
lstmn=1L & lstdy=22L & lstyr=9L
ledmn=1L & leddy=22L & ledyr=9L
lstday=0L & ledday=0L
...
;
      ...
      if setplot eq 'ps' then begin
         ...
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
                /bold,/color,bits_per_pixel=8,/helvetica,filename=ifile+'_'+stheta+'K_pv+mark.ps'
         !p.charsize=1.25
         !p.thick=2
         !p.charthick=5
         !p.charthick=5
      ...
      MAP_SET,90,0,-90,/ortho,/noeras,/grid,/contin,title=date,color=0
      ...
      contour,pv,x,alat,/overplot,levels=[0.0],thick=5,color=0
      contour,mark,x,alat,/overplot,levels=[0.1],thick=12,color=0
      ...
      if setplot eq 'ps' then begin
         device, /close
         spawn,'convert -trim '+ifile+'_'+stheta+'K_pv+mark.ps -rotate -90 '+ifile+'_'+stheta+'K_pv+mark.jpg'
      endif
goto,jump
end
