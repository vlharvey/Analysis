...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/times,filename='../Figures/waccm_vortex_centroids_ES_composite.ps'
   !p.charsize=1.25
   !p.thick=2
   !p.charthick=5
   !p.charthick=5
...
;endfor
      if setplot ne 'ps' then stop
        if setplot eq 'ps' then begin
           device, /close
           spawn,'convert ../Figures/waccm_vortex_centroids_ES_composite.ps -rotate -90 /Users/harvey/Harvey_etal_2014/Figures/waccm_vortex_centroids_ES_composite.png'
;          spawn,'rm -f ../Figures/waccm_vortex_centroids_ES_composite.ps'
        endif
end
