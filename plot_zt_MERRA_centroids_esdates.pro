...
;
    if setplot eq 'ps' then begin
       ...
       device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
              /bold,/color,bits_per_pixel=8,/times,filename='../Figures/merra_zt_centroids_ES_event_'+sevent+'.ps'
       !p.charsize=1.25
       !p.thick=2
       !p.charthick=5
       !p.charthick=5
...
y1=y1+dy
    ...
    if setplot eq 'ps' then begin
       device, /close
       spawn,'convert -trim ../Figures/merra_zt_centroids_ES_event_'+sevent+'.ps -rotate -90 ../Figures/merra_zt_centroids_ES_event_'+sevent+'.png'
       spawn,'rm -f ../Figures/merra_zt_centroids_ES_event_'+sevent+'.ps'
    endif
