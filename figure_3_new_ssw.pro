...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='figure_3_new_ssw.ps'
endif
erase
!type=2^2+2^3
xmn=xorig(0)
...
ymx=yorig(1)+ylen
set_viewport,xmn,xmx,ymn,ymx
restore,'geos5_nh_sf_pv_difflat_save_daily_ssw.sav
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim figure_3_new_ssw.ps -rotate -90 figure_3_new_ssw.jpg'
;  spawn,'/usr/bin/rm figure_3_new_ssw.ps'
endif
end
