...
;
; interpolate GEOS-5 marker to 2d MLS array (mco)
...
;
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='nh_geos5_vortex+mls_coswaths_'+sdate+'_1pan.ps'
       device,/color
...
loadct,38
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim nh_geos5_vortex+mls_coswaths_'+sdate+'_1pan.ps -rotate -90 '+$
             'nh_geos5_vortex+mls_coswaths_'+sdate+'_1pan.jpg'
       spawn,'/usr/bin/rm -f nh_geos5_vortex+mls_coswaths_'+sdate+'_1pan.ps'
    endif
    icount=icount+1L
goto,jump
end
