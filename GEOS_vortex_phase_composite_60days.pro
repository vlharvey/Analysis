...
restore,'ES_composite_days_geos5_dm30-dp30.sav' ;,alon,alat,th,nc,nr,nth,pv2_comp,p2_comp,u2_comp,v2_comp,qdf2_comp,q2_comp,gph2_comp,ttgw2_comp,sf2_comp,mark2_comp
;
; wrap around point
;
        lons = fltarr(nc+1L)
...
;       endfor
        ...
        if setplot eq 'ps' then begin
           device, /close
           spawn,'convert -trim ../Figures/geos5_vortex_phase_ES_composite.ps -rotate -90 /Users/harvey/Harvey_etal_2014/Figures/geos5_vortex_phase_ES_composite.png'
